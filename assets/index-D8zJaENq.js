import{V as M,a as Ga}from"./vendor-B8rkbpW9.js";import{i as hi}from"./utils-u3wYLQ4o.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))t(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&t(o)}).observe(document,{childList:!0,subtree:!0});function a(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function t(i){if(i.ep)return;i.ep=!0;const r=a(i);fetch(i.href,r)}})();const fi=`access	v. 获取 n. 接近，入口
project	n. 工程；课题、作业
intention	n. 打算，意图
equivalence	n. 等值，相等
...
snap	 v. 咔嚓折断，啪地绷断；吧嗒一声；猛咬；厉声说话，怒声责骂 adj. 仓促的， 突然的 n. 吧嗒声；快照`,gi=`
consistent	adj. 一致的
battery	n. 电池
...
`;let Mn=[];Mn.push(Fe(1,"cet4",fi));Mn.push(Fe(2,"cet6",gi));Mn.push(Fe(3,"sta",yi));const bi=Mn;function Fe(e,n,a){const t=a.split(`
`).filter(Boolean).map((i,r)=>{const[o,s]=i.split("	");return{en:o,zh:s,idx:r}});return{id:e,name:n,words:t}}function wi(){if(typeof global<"u")return global.window;if(typeof window<"u")return window}function ki(e){if(Qa(e))try{return JSON.parse(e),!0}catch{return!1}return!1}function Va(e,n=void 0){return ki(e)?xi(e):n}function xi(e="",n){try{return JSON.parse(e)}catch(a){return console.error("jsonParse error",a,e),console.error("如果要忽略jsonParse的报错，可以调用saveJsonParse，但最好还是查下为什么报错"),n}}function fe(e,n=void 0,a={}){let{replacer:t,space:i}=a;try{return JSON.stringify(e,t,i)}catch(r){return console.error("jsonStringify error ",r),n}}function Ha(e){return Array.isArray(e)}function jn(e){return typeof e=="object"&&e!==null&&!Ha(e)}function _i(e){return typeof e=="function"}function Qa(e){return typeof e=="string"||e instanceof String}function ge(e){if(typeof e!="object"||e===null)return e;let n;if(Array.isArray(e)){n=[];for(let a=0;a<e.length;a++)n[a]=ge(e[a])}else{n={};for(let a in e)e.hasOwnProperty(a)&&(n[a]=ge(e[a]))}return n}function Xa(){let e=Array.from(arguments);return e.reduce(n,e[0]);function n(a,t){if(a||(a=Array.isArray(t)?[]:{}),t&&typeof t=="object")for(let i in t)t.hasOwnProperty(i)&&(t[i]&&typeof t[i]=="object"?a[i]=n(a[i],t[i]):a[i]=t[i]);return a}}function oa(e,n="",a){if(!jn(e))return;let t=e,i=n.split("."),r=i.slice(0,i.length-1),o=i[i.length-1];for(let s of r){let c=e[s];jn(c)||(e[s]={}),e=e[s]}return e[o]=a,t}function Dn(e,n="",a=void 0){if(!jn(e)||!Qa(n))return a;const t=n.split(".");let i=e;for(const r of t){if(/\[\d+]/.test(r)){const o=parseInt(r.match(/\d+/)[0]);i=i[o]}else i=i[r];if(i===void 0)return a}return i}function Ja(e,n){return{cache:e,getData(){return this.cache},containsKey(a){return this.cache.hasOwnProperty(a)},getCache(a){return this.clearExpire(),this.cache[a]?this.cache[a].value:{}.value},setCache(a,t){this.clearExpire(),this.cache[a]={timestamp:new Date().getTime(),value:t}},clearCache(){Object.keys(this.cache).forEach(a=>{delete this.cache[a]})},init(a){Object.assign(this.cache,a)},clearExpire(){let a=new Date().getTime();Object.keys(this.cache).forEach(t=>{let i=this.cache[t]||{};if(!i.timestamp){delete this.cache[t];return}let r=i.timestamp;a-r>n&&delete this.cache[t]})}}}function Ka(e,n,a="localStorage"){let t=wi(),i=Dn(t||{},a),r=i||{getItem(){},setItem(){},removeItem(){}},o=r.getItem instanceof Function?r.getItem(e):"{}",s=Va(o,{})||{},c=Ja(s,n);return{Cacher:c,getCache(d){return c.getCache(d)},setCache(d,l){c.setCache(d,l);let v=c.getData();try{r.setItem(e,fe(v))}catch(j){console.error(`setCache exception; key=${d}, value=${l}; error=`,j),this.reportError(d,l)}},getTotalData(){return c.getData()},reportError(d,l){let v=c.getData(),j="";Object.keys(v).forEach(p=>{let m=Dn(v,`${p}.value`),f=(jn(m)?fe(m):m)+"";j.length<f.length&&(j=f)})},clearCache(){c.clearCache(),r.removeItem(e)}}}(function(){return Ka("_diskCache",31536e6,"localStorage")})();(function(){return Ka("_ssDiskCache",31536e6,"sessionStorage")})();function Ei(e){const n=Ja({});return function(...a){const t=JSON.stringify(a);if(n.containsKey(t))return n.getCache(t);const i=e.apply(this,a);return n.setCache(t,i),i}}function Si(e,n=300){let a;return function(...t){clearTimeout(a),a=setTimeout(()=>{_i(e)&&e.apply(this,t)},n)}}function Un(e=0){return new Promise(n=>{setTimeout(n,e)})}const Ci=(()=>{function e(a){if(!a)return{};const t={},i=(a[0]==="?"?a.substring(1):a).split("&");for(let r=0;r<i.length;r++){const o=i[r].split("="),s=decodeURIComponent(o[0]),c=o.length===2?decodeURIComponent(o[1]):null;t[s]===void 0?t[s]=c:Array.isArray(t[s])?t[s].push(c):t[s]=[t[s],c]}return t}function n(a){return""+Object.keys(a).map(t=>{const i=a[t];return Array.isArray(i)?i.map(r=>`${encodeURIComponent(t)}=${encodeURIComponent(r)}`).join("&"):`${encodeURIComponent(t)}=${encodeURIComponent(i)}`}).join("&")}return{parse:e,stringify:n}})(),Ii=e=>{e.interceptors.request.use(n=>{if(n.method==="post"){n.headers["Content-Type"]="application/x-www-form-urlencoded;charset=UTF-8";let a={};Object.keys(n.data).forEach(t=>{let i=n.data[t];typeof i=="object"?a[t]=JSON.stringify(i):a[t]=i}),n.data=Ci.stringify(a)}return n},n=>Promise.reject(n))},qi=e=>{e.interceptors.request.use(n=>{let a=Ri();return a&&(n.params=Xa({},n.params,{_TOKEN:a})),n})};function Ri(){try{return window.document.querySelector("#_TOKEN").getAttribute("value")}catch{return""}}const zi=e=>{e.interceptors.request.use(n=>(n.method==="get"&&(n.params=Ai(n.params)),n))},Ai=e=>(e||(e={}),Object.keys(e).forEach(n=>{let a=e[n];(jn(a)||Ha(a))&&(a=fe(a)),e[n]=a}),e);function Ya(e,n){return function(){return e.apply(n,arguments)}}const{toString:Ti}=Object.prototype,{getPrototypeOf:Be}=Object,Wn=(e=>n=>{const a=Ti.call(n);return e[a]||(e[a]=a.slice(8,-1).toLowerCase())})(Object.create(null)),L=e=>(e=e.toLowerCase(),n=>Wn(n)===e),Gn=e=>n=>typeof n===e,{isArray:rn}=Array,mn=Gn("undefined");function Di(e){return e!==null&&!mn(e)&&e.constructor!==null&&!mn(e.constructor)&&O(e.constructor.isBuffer)&&e.constructor.isBuffer(e)}const Za=L("ArrayBuffer");function Oi(e){let n;return typeof ArrayBuffer<"u"&&ArrayBuffer.isView?n=ArrayBuffer.isView(e):n=e&&e.buffer&&Za(e.buffer),n}const Ni=Gn("string"),O=Gn("function"),nt=Gn("number"),Vn=e=>e!==null&&typeof e=="object",$i=e=>e===!0||e===!1,In=e=>{if(Wn(e)!=="object")return!1;const n=Be(e);return(n===null||n===Object.prototype||Object.getPrototypeOf(n)===null)&&!(Symbol.toStringTag in e)&&!(Symbol.iterator in e)},Li=L("Date"),Pi=L("File"),Fi=L("Blob"),Bi=L("FileList"),Mi=e=>Vn(e)&&O(e.pipe),Ui=e=>{let n;return e&&(typeof FormData=="function"&&e instanceof FormData||O(e.append)&&((n=Wn(e))==="formdata"||n==="object"&&O(e.toString)&&e.toString()==="[object FormData]"))},Wi=L("URLSearchParams"),[Gi,Vi,Hi,Qi]=["ReadableStream","Request","Response","Headers"].map(L),Xi=e=>e.trim?e.trim():e.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,"");function yn(e,n,{allOwnKeys:a=!1}={}){if(e===null||typeof e>"u")return;let t,i;if(typeof e!="object"&&(e=[e]),rn(e))for(t=0,i=e.length;t<i;t++)n.call(null,e[t],t,e);else{const r=a?Object.getOwnPropertyNames(e):Object.keys(e),o=r.length;let s;for(t=0;t<o;t++)s=r[t],n.call(null,e[s],s,e)}}function et(e,n){n=n.toLowerCase();const a=Object.keys(e);let t=a.length,i;for(;t-- >0;)if(i=a[t],n===i.toLowerCase())return i;return null}const at=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:global,tt=e=>!mn(e)&&e!==at;function ye(){const{caseless:e}=tt(this)&&this||{},n={},a=(t,i)=>{const r=e&&et(n,i)||i;In(n[r])&&In(t)?n[r]=ye(n[r],t):In(t)?n[r]=ye({},t):rn(t)?n[r]=t.slice():n[r]=t};for(let t=0,i=arguments.length;t<i;t++)arguments[t]&&yn(arguments[t],a);return n}const Ji=(e,n,a,{allOwnKeys:t}={})=>(yn(n,(i,r)=>{a&&O(i)?e[r]=Ya(i,a):e[r]=i},{allOwnKeys:t}),e),Ki=e=>(e.charCodeAt(0)===65279&&(e=e.slice(1)),e),Yi=(e,n,a,t)=>{e.prototype=Object.create(n.prototype,t),e.prototype.constructor=e,Object.defineProperty(e,"super",{value:n.prototype}),a&&Object.assign(e.prototype,a)},Zi=(e,n,a,t)=>{let i,r,o;const s={};if(n=n||{},e==null)return n;do{for(i=Object.getOwnPropertyNames(e),r=i.length;r-- >0;)o=i[r],(!t||t(o,e,n))&&!s[o]&&(n[o]=e[o],s[o]=!0);e=a!==!1&&Be(e)}while(e&&(!a||a(e,n))&&e!==Object.prototype);return n},nr=(e,n,a)=>{e=String(e),(a===void 0||a>e.length)&&(a=e.length),a-=n.length;const t=e.indexOf(n,a);return t!==-1&&t===a},er=e=>{if(!e)return null;if(rn(e))return e;let n=e.length;if(!nt(n))return null;const a=new Array(n);for(;n-- >0;)a[n]=e[n];return a},ar=(e=>n=>e&&n instanceof e)(typeof Uint8Array<"u"&&Be(Uint8Array)),tr=(e,n)=>{const a=(e&&e[Symbol.iterator]).call(e);let t;for(;(t=a.next())&&!t.done;){const i=t.value;n.call(e,i[0],i[1])}},ir=(e,n)=>{let a;const t=[];for(;(a=e.exec(n))!==null;)t.push(a);return t},rr=L("HTMLFormElement"),or=e=>e.toLowerCase().replace(/[-_\s]([a-z\d])(\w*)/g,function(n,a,t){return a.toUpperCase()+t}),sa=(({hasOwnProperty:e})=>(n,a)=>e.call(n,a))(Object.prototype),sr=L("RegExp"),it=(e,n)=>{const a=Object.getOwnPropertyDescriptors(e),t={};yn(a,(i,r)=>{let o;(o=n(i,r,e))!==!1&&(t[r]=o||i)}),Object.defineProperties(e,t)},dr=e=>{it(e,(n,a)=>{if(O(e)&&["arguments","caller","callee"].indexOf(a)!==-1)return!1;const t=e[a];if(O(t)){if(n.enumerable=!1,"writable"in n){n.writable=!1;return}n.set||(n.set=()=>{throw Error("Can not rewrite read-only method '"+a+"'")})}})},cr=(e,n)=>{const a={},t=i=>{i.forEach(r=>{a[r]=!0})};return rn(e)?t(e):t(String(e).split(n)),a},lr=()=>{},vr=(e,n)=>e!=null&&Number.isFinite(e=+e)?e:n,re="abcdefghijklmnopqrstuvwxyz",da="0123456789",rt={DIGIT:da,ALPHA:re,ALPHA_DIGIT:re+re.toUpperCase()+da},ur=(e=16,n=rt.ALPHA_DIGIT)=>{let a="";const{length:t}=n;for(;e--;)a+=n[Math.random()*t|0];return a};function pr(e){return!!(e&&O(e.append)&&e[Symbol.toStringTag]==="FormData"&&e[Symbol.iterator])}const jr=e=>{const n=new Array(10),a=(t,i)=>{if(Vn(t)){if(n.indexOf(t)>=0)return;if(!("toJSON"in t)){n[i]=t;const r=rn(t)?[]:{};return yn(t,(o,s)=>{const c=a(o,i+1);!mn(c)&&(r[s]=c)}),n[i]=void 0,r}}return t};return a(e,0)},mr=L("AsyncFunction"),hr=e=>e&&(Vn(e)||O(e))&&O(e.then)&&O(e.catch),u={isArray:rn,isArrayBuffer:Za,isBuffer:Di,isFormData:Ui,isArrayBufferView:Oi,isString:Ni,isNumber:nt,isBoolean:$i,isObject:Vn,isPlainObject:In,isReadableStream:Gi,isRequest:Vi,isResponse:Hi,isHeaders:Qi,isUndefined:mn,isDate:Li,isFile:Pi,isBlob:Fi,isRegExp:sr,isFunction:O,isStream:Mi,isURLSearchParams:Wi,isTypedArray:ar,isFileList:Bi,forEach:yn,merge:ye,extend:Ji,trim:Xi,stripBOM:Ki,inherits:Yi,toFlatObject:Zi,kindOf:Wn,kindOfTest:L,endsWith:nr,toArray:er,forEachEntry:tr,matchAll:ir,isHTMLForm:rr,hasOwnProperty:sa,hasOwnProp:sa,reduceDescriptors:it,freezeMethods:dr,toObjectSet:cr,toCamelCase:or,noop:lr,toFiniteNumber:vr,findKey:et,global:at,isContextDefined:tt,ALPHABET:rt,generateString:ur,isSpecCompliantForm:pr,toJSONObject:jr,isAsyncFn:mr,isThenable:hr};function h(e,n,a,t,i){Error.call(this),Error.captureStackTrace?Error.captureStackTrace(this,this.constructor):this.stack=new Error().stack,this.message=e,this.name="AxiosError",n&&(this.code=n),a&&(this.config=a),t&&(this.request=t),i&&(this.response=i)}u.inherits(h,Error,{toJSON:function(){return{message:this.message,name:this.name,description:this.description,number:this.number,fileName:this.fileName,lineNumber:this.lineNumber,columnNumber:this.columnNumber,stack:this.stack,config:u.toJSONObject(this.config),code:this.code,status:this.response&&this.response.status?this.response.status:null}}});const ot=h.prototype,st={};["ERR_BAD_OPTION_VALUE","ERR_BAD_OPTION","ECONNABORTED","ETIMEDOUT","ERR_NETWORK","ERR_FR_TOO_MANY_REDIRECTS","ERR_DEPRECATED","ERR_BAD_RESPONSE","ERR_BAD_REQUEST","ERR_CANCELED","ERR_NOT_SUPPORT","ERR_INVALID_URL"].forEach(e=>{st[e]={value:e}});Object.defineProperties(h,st);Object.defineProperty(ot,"isAxiosError",{value:!0});h.from=(e,n,a,t,i,r)=>{const o=Object.create(ot);return u.toFlatObject(e,o,function(s){return s!==Error.prototype},s=>s!=="isAxiosError"),h.call(o,e.message,n,a,t,i),o.cause=e,o.name=e.name,r&&Object.assign(o,r),o};const fr=null;function be(e){return u.isPlainObject(e)||u.isArray(e)}function dt(e){return u.endsWith(e,"[]")?e.slice(0,-2):e}function ca(e,n,a){return e?e.concat(n).map(function(t,i){return t=dt(t),!a&&i?"["+t+"]":t}).join(a?".":""):n}function gr(e){return u.isArray(e)&&!e.some(be)}const yr=u.toFlatObject(u,{},null,function(e){return/^is[A-Z]/.test(e)});function Hn(e,n,a){if(!u.isObject(e))throw new TypeError("target must be an object");n=n||new FormData,a=u.toFlatObject(a,{metaTokens:!0,dots:!1,indexes:!1},!1,function(p,m){return!u.isUndefined(m[p])});const t=a.metaTokens,i=a.visitor||d,r=a.dots,o=a.indexes,s=(a.Blob||typeof Blob<"u"&&Blob)&&u.isSpecCompliantForm(n);if(!u.isFunction(i))throw new TypeError("visitor must be a function");function c(p){if(p===null)return"";if(u.isDate(p))return p.toISOString();if(!s&&u.isBlob(p))throw new h("Blob is not supported. Use a Buffer instead.");return u.isArrayBuffer(p)||u.isTypedArray(p)?s&&typeof Blob=="function"?new Blob([p]):Buffer.from(p):p}function d(p,m,f){let k=p;if(p&&!f&&typeof p=="object"){if(u.endsWith(m,"{}"))m=t?m:m.slice(0,-2),p=JSON.stringify(p);else if(u.isArray(p)&&gr(p)||(u.isFileList(p)||u.endsWith(m,"[]"))&&(k=u.toArray(p)))return m=dt(m),k.forEach(function(q,E){!(u.isUndefined(q)||q===null)&&n.append(o===!0?ca([m],E,r):o===null?m:m+"[]",c(q))}),!1}return be(p)?!0:(n.append(ca(f,m,r),c(p)),!1)}const l=[],v=Object.assign(yr,{defaultVisitor:d,convertValue:c,isVisitable:be});function j(p,m){if(!u.isUndefined(p)){if(l.indexOf(p)!==-1)throw Error("Circular reference detected in "+m.join("."));l.push(p),u.forEach(p,function(f,k){(!(u.isUndefined(f)||f===null)&&i.call(n,f,u.isString(k)?k.trim():k,m,v))===!0&&j(f,m?m.concat(k):[k])}),l.pop()}}if(!u.isObject(e))throw new TypeError("data must be an object");return j(e),n}function la(e){const n={"!":"%21","'":"%27","(":"%28",")":"%29","~":"%7E","%20":"+","%00":"\0"};return encodeURIComponent(e).replace(/[!'()~]|%20|%00/g,function(a){return n[a]})}function Me(e,n){this._pairs=[],e&&Hn(e,this,n)}const ct=Me.prototype;ct.append=function(e,n){this._pairs.push([e,n])};ct.toString=function(e){const n=e?function(a){return e.call(this,a,la)}:la;return this._pairs.map(function(a){return n(a[0])+"="+n(a[1])},"").join("&")};function br(e){return encodeURIComponent(e).replace(/%3A/gi,":").replace(/%24/g,"$").replace(/%2C/gi,",").replace(/%20/g,"+").replace(/%5B/gi,"[").replace(/%5D/gi,"]")}function lt(e,n,a){if(!n)return e;const t=a&&a.encode||br,i=a&&a.serialize;let r;if(i?r=i(n,a):r=u.isURLSearchParams(n)?n.toString():new Me(n,a).toString(t),r){const o=e.indexOf("#");o!==-1&&(e=e.slice(0,o)),e+=(e.indexOf("?")===-1?"?":"&")+r}return e}class va{constructor(){this.handlers=[]}use(n,a,t){return this.handlers.push({fulfilled:n,rejected:a,synchronous:t?t.synchronous:!1,runWhen:t?t.runWhen:null}),this.handlers.length-1}eject(n){this.handlers[n]&&(this.handlers[n]=null)}clear(){this.handlers&&(this.handlers=[])}forEach(n){u.forEach(this.handlers,function(a){a!==null&&n(a)})}}const vt={silentJSONParsing:!0,forcedJSONParsing:!0,clarifyTimeoutError:!1},wr=typeof URLSearchParams<"u"?URLSearchParams:Me,kr=typeof FormData<"u"?FormData:null,xr=typeof Blob<"u"?Blob:null,_r={isBrowser:!0,classes:{URLSearchParams:wr,FormData:kr,Blob:xr},protocols:["http","https","file","blob","url","data"]},Ue=typeof window<"u"&&typeof document<"u",Er=(e=>Ue&&["ReactNative","NativeScript","NS"].indexOf(e)<0)(typeof navigator<"u"&&navigator.product),Sr=typeof WorkerGlobalScope<"u"&&self instanceof WorkerGlobalScope&&typeof self.importScripts=="function",Cr=Ue&&window.location.href||"http://localhost",Ir=Object.freeze(Object.defineProperty({__proto__:null,hasBrowserEnv:Ue,hasStandardBrowserEnv:Er,hasStandardBrowserWebWorkerEnv:Sr,origin:Cr},Symbol.toStringTag,{value:"Module"})),$={...Ir,..._r};function qr(e,n){return Hn(e,new $.classes.URLSearchParams,Object.assign({visitor:function(a,t,i,r){return $.isNode&&u.isBuffer(a)?(this.append(t,a.toString("base64")),!1):r.defaultVisitor.apply(this,arguments)}},n))}function Rr(e){return u.matchAll(/\w+|\[(\w*)]/g,e).map(n=>n[0]==="[]"?"":n[1]||n[0])}function zr(e){const n={},a=Object.keys(e);let t;const i=a.length;let r;for(t=0;t<i;t++)r=a[t],n[r]=e[r];return n}function ut(e){function n(a,t,i,r){let o=a[r++];if(o==="__proto__")return!0;const s=Number.isFinite(+o),c=r>=a.length;return o=!o&&u.isArray(i)?i.length:o,c?(u.hasOwnProp(i,o)?i[o]=[i[o],t]:i[o]=t,!s):((!i[o]||!u.isObject(i[o]))&&(i[o]=[]),n(a,t,i[o],r)&&u.isArray(i[o])&&(i[o]=zr(i[o])),!s)}if(u.isFormData(e)&&u.isFunction(e.entries)){const a={};return u.forEachEntry(e,(t,i)=>{n(Rr(t),i,a,0)}),a}return null}function Ar(e,n,a){if(u.isString(e))try{return(n||JSON.parse)(e),u.trim(e)}catch(t){if(t.name!=="SyntaxError")throw t}return(a||JSON.stringify)(e)}const bn={transitional:vt,adapter:["xhr","http","fetch"],transformRequest:[function(e,n){const a=n.getContentType()||"",t=a.indexOf("application/json")>-1,i=u.isObject(e);if(i&&u.isHTMLForm(e)&&(e=new FormData(e)),u.isFormData(e))return t?JSON.stringify(ut(e)):e;if(u.isArrayBuffer(e)||u.isBuffer(e)||u.isStream(e)||u.isFile(e)||u.isBlob(e)||u.isReadableStream(e))return e;if(u.isArrayBufferView(e))return e.buffer;if(u.isURLSearchParams(e))return n.setContentType("application/x-www-form-urlencoded;charset=utf-8",!1),e.toString();let r;if(i){if(a.indexOf("application/x-www-form-urlencoded")>-1)return qr(e,this.formSerializer).toString();if((r=u.isFileList(e))||a.indexOf("multipart/form-data")>-1){const o=this.env&&this.env.FormData;return Hn(r?{"files[]":e}:e,o&&new o,this.formSerializer)}}return i||t?(n.setContentType("application/json",!1),Ar(e)):e}],transformResponse:[function(e){const n=this.transitional||bn.transitional,a=n&&n.forcedJSONParsing,t=this.responseType==="json";if(u.isResponse(e)||u.isReadableStream(e))return e;if(e&&u.isString(e)&&(a&&!this.responseType||t)){const i=!(n&&n.silentJSONParsing)&&t;try{return JSON.parse(e)}catch(r){if(i)throw r.name==="SyntaxError"?h.from(r,h.ERR_BAD_RESPONSE,this,null,this.response):r}}return e}],timeout:0,xsrfCookieName:"XSRF-TOKEN",xsrfHeaderName:"X-XSRF-TOKEN",maxContentLength:-1,maxBodyLength:-1,env:{FormData:$.classes.FormData,Blob:$.classes.Blob},validateStatus:function(e){return e>=200&&e<300},headers:{common:{Accept:"application/json, text/plain, */*","Content-Type":void 0}}};u.forEach(["delete","get","head","post","put","patch"],e=>{bn.headers[e]={}});const Tr=u.toObjectSet(["age","authorization","content-length","content-type","etag","expires","from","host","if-modified-since","if-unmodified-since","last-modified","location","max-forwards","proxy-authorization","referer","retry-after","user-agent"]),Dr=e=>{const n={};let a,t,i;return e&&e.split(`
`).forEach(function(r){i=r.indexOf(":"),a=r.substring(0,i).trim().toLowerCase(),t=r.substring(i+1).trim(),!(!a||n[a]&&Tr[a])&&(a==="set-cookie"?n[a]?n[a].push(t):n[a]=[t]:n[a]=n[a]?n[a]+", "+t:t)}),n},ua=Symbol("internals");function ln(e){return e&&String(e).trim().toLowerCase()}function qn(e){return e===!1||e==null?e:u.isArray(e)?e.map(qn):String(e)}function Or(e){const n=Object.create(null),a=/([^\s,;=]+)\s*(?:=\s*([^,;]+))?/g;let t;for(;t=a.exec(e);)n[t[1]]=t[2];return n}const Nr=e=>/^[-_a-zA-Z0-9^`|~,!#$%&'*+.]+$/.test(e.trim());function oe(e,n,a,t,i){if(u.isFunction(t))return t.call(this,n,a);if(i&&(n=a),!!u.isString(n)){if(u.isString(t))return n.indexOf(t)!==-1;if(u.isRegExp(t))return t.test(n)}}function $r(e){return e.trim().toLowerCase().replace(/([a-z\d])(\w*)/g,(n,a,t)=>a.toUpperCase()+t)}function Lr(e,n){const a=u.toCamelCase(" "+n);["get","set","has"].forEach(t=>{Object.defineProperty(e,t+a,{value:function(i,r,o){return this[t].call(this,n,i,r,o)},configurable:!0})})}let z=class{constructor(e){e&&this.set(e)}set(e,n,a){const t=this;function i(o,s,c){const d=ln(s);if(!d)throw new Error("header name must be a non-empty string");const l=u.findKey(t,d);(!l||t[l]===void 0||c===!0||c===void 0&&t[l]!==!1)&&(t[l||s]=qn(o))}const r=(o,s)=>u.forEach(o,(c,d)=>i(c,d,s));if(u.isPlainObject(e)||e instanceof this.constructor)r(e,n);else if(u.isString(e)&&(e=e.trim())&&!Nr(e))r(Dr(e),n);else if(u.isHeaders(e))for(const[o,s]of e.entries())i(s,o,a);else e!=null&&i(n,e,a);return this}get(e,n){if(e=ln(e),e){const a=u.findKey(this,e);if(a){const t=this[a];if(!n)return t;if(n===!0)return Or(t);if(u.isFunction(n))return n.call(this,t,a);if(u.isRegExp(n))return n.exec(t);throw new TypeError("parser must be boolean|regexp|function")}}}has(e,n){if(e=ln(e),e){const a=u.findKey(this,e);return!!(a&&this[a]!==void 0&&(!n||oe(this,this[a],a,n)))}return!1}delete(e,n){const a=this;let t=!1;function i(r){if(r=ln(r),r){const o=u.findKey(a,r);o&&(!n||oe(a,a[o],o,n))&&(delete a[o],t=!0)}}return u.isArray(e)?e.forEach(i):i(e),t}clear(e){const n=Object.keys(this);let a=n.length,t=!1;for(;a--;){const i=n[a];(!e||oe(this,this[i],i,e,!0))&&(delete this[i],t=!0)}return t}normalize(e){const n=this,a={};return u.forEach(this,(t,i)=>{const r=u.findKey(a,i);if(r){n[r]=qn(t),delete n[i];return}const o=e?$r(i):String(i).trim();o!==i&&delete n[i],n[o]=qn(t),a[o]=!0}),this}concat(...e){return this.constructor.concat(this,...e)}toJSON(e){const n=Object.create(null);return u.forEach(this,(a,t)=>{a!=null&&a!==!1&&(n[t]=e&&u.isArray(a)?a.join(", "):a)}),n}[Symbol.iterator](){return Object.entries(this.toJSON())[Symbol.iterator]()}toString(){return Object.entries(this.toJSON()).map(([e,n])=>e+": "+n).join(`
`)}get[Symbol.toStringTag](){return"AxiosHeaders"}static from(e){return e instanceof this?e:new this(e)}static concat(e,...n){const a=new this(e);return n.forEach(t=>a.set(t)),a}static accessor(e){const n=(this[ua]=this[ua]={accessors:{}}).accessors,a=this.prototype;function t(i){const r=ln(i);n[r]||(Lr(a,i),n[r]=!0)}return u.isArray(e)?e.forEach(t):t(e),this}};z.accessor(["Content-Type","Content-Length","Accept","Accept-Encoding","User-Agent","Authorization"]);u.reduceDescriptors(z.prototype,({value:e},n)=>{let a=n[0].toUpperCase()+n.slice(1);return{get:()=>e,set(t){this[a]=t}}});u.freezeMethods(z);function se(e,n){const a=this||bn,t=n||a,i=z.from(t.headers);let r=t.data;return u.forEach(e,function(o){r=o.call(a,r,i.normalize(),n?n.status:void 0)}),i.normalize(),r}function pt(e){return!!(e&&e.__CANCEL__)}function on(e,n,a){h.call(this,e??"canceled",h.ERR_CANCELED,n,a),this.name="CanceledError"}u.inherits(on,h,{__CANCEL__:!0});function jt(e,n,a){const t=a.config.validateStatus;!a.status||!t||t(a.status)?e(a):n(new h("Request failed with status code "+a.status,[h.ERR_BAD_REQUEST,h.ERR_BAD_RESPONSE][Math.floor(a.status/100)-4],a.config,a.request,a))}function Pr(e){const n=/^([-+\w]{1,25})(:?\/\/|:)/.exec(e);return n&&n[1]||""}function Fr(e,n){e=e||10;const a=new Array(e),t=new Array(e);let i=0,r=0,o;return n=n!==void 0?n:1e3,function(s){const c=Date.now(),d=t[r];o||(o=c),a[i]=s,t[i]=c;let l=r,v=0;for(;l!==i;)v+=a[l++],l=l%e;if(i=(i+1)%e,i===r&&(r=(r+1)%e),c-o<n)return;const j=d&&c-d;return j?Math.round(v*1e3/j):void 0}}function Br(e,n){let a=0;const t=1e3/n;let i=null;return function(){const r=this===!0,o=Date.now();if(r||o-a>t)return i&&(clearTimeout(i),i=null),a=o,e.apply(null,arguments);i||(i=setTimeout(()=>(i=null,a=Date.now(),e.apply(null,arguments)),t-(o-a)))}}const On=(e,n,a=3)=>{let t=0;const i=Fr(50,250);return Br(r=>{const o=r.loaded,s=r.lengthComputable?r.total:void 0,c=o-t,d=i(c),l=o<=s;t=o;const v={loaded:o,total:s,progress:s?o/s:void 0,bytes:c,rate:d||void 0,estimated:d&&s&&l?(s-o)/d:void 0,event:r,lengthComputable:s!=null};v[n?"download":"upload"]=!0,e(v)},a)},Mr=$.hasStandardBrowserEnv?function(){const e=/(msie|trident)/i.test(navigator.userAgent),n=document.createElement("a");let a;function t(i){let r=i;return e&&(n.setAttribute("href",r),r=n.href),n.setAttribute("href",r),{href:n.href,protocol:n.protocol?n.protocol.replace(/:$/,""):"",host:n.host,search:n.search?n.search.replace(/^\?/,""):"",hash:n.hash?n.hash.replace(/^#/,""):"",hostname:n.hostname,port:n.port,pathname:n.pathname.charAt(0)==="/"?n.pathname:"/"+n.pathname}}return a=t(window.location.href),function(i){const r=u.isString(i)?t(i):i;return r.protocol===a.protocol&&r.host===a.host}}():function(){return function(){return!0}}(),Ur=$.hasStandardBrowserEnv?{write(e,n,a,t,i,r){const o=[e+"="+encodeURIComponent(n)];u.isNumber(a)&&o.push("expires="+new Date(a).toGMTString()),u.isString(t)&&o.push("path="+t),u.isString(i)&&o.push("domain="+i),r===!0&&o.push("secure"),document.cookie=o.join("; ")},read(e){const n=document.cookie.match(new RegExp("(^|;\\s*)("+e+")=([^;]*)"));return n?decodeURIComponent(n[3]):null},remove(e){this.write(e,"",Date.now()-864e5)}}:{write(){},read(){return null},remove(){}};function Wr(e){return/^([a-z][a-z\d+\-.]*:)?\/\//i.test(e)}function Gr(e,n){return n?e.replace(/\/?\/$/,"")+"/"+n.replace(/^\/+/,""):e}function mt(e,n){return e&&!Wr(n)?Gr(e,n):n}const pa=e=>e instanceof z?{...e}:e;function Y(e,n){n=n||{};const a={};function t(d,l,v){return u.isPlainObject(d)&&u.isPlainObject(l)?u.merge.call({caseless:v},d,l):u.isPlainObject(l)?u.merge({},l):u.isArray(l)?l.slice():l}function i(d,l,v){if(u.isUndefined(l)){if(!u.isUndefined(d))return t(void 0,d,v)}else return t(d,l,v)}function r(d,l){if(!u.isUndefined(l))return t(void 0,l)}function o(d,l){if(u.isUndefined(l)){if(!u.isUndefined(d))return t(void 0,d)}else return t(void 0,l)}function s(d,l,v){if(v in n)return t(d,l);if(v in e)return t(void 0,d)}const c={url:r,method:r,data:r,baseURL:o,transformRequest:o,transformResponse:o,paramsSerializer:o,timeout:o,timeoutMessage:o,withCredentials:o,withXSRFToken:o,adapter:o,responseType:o,xsrfCookieName:o,xsrfHeaderName:o,onUploadProgress:o,onDownloadProgress:o,decompress:o,maxContentLength:o,maxBodyLength:o,beforeRedirect:o,transport:o,httpAgent:o,httpsAgent:o,cancelToken:o,socketPath:o,responseEncoding:o,validateStatus:s,headers:(d,l)=>i(pa(d),pa(l),!0)};return u.forEach(Object.keys(Object.assign({},e,n)),function(d){const l=c[d]||i,v=l(e[d],n[d],d);u.isUndefined(v)&&l!==s||(a[d]=v)}),a}const ht=e=>{const n=Y({},e);let{data:a,withXSRFToken:t,xsrfHeaderName:i,xsrfCookieName:r,headers:o,auth:s}=n;n.headers=o=z.from(o),n.url=lt(mt(n.baseURL,n.url),e.params,e.paramsSerializer),s&&o.set("Authorization","Basic "+btoa((s.username||"")+":"+(s.password?unescape(encodeURIComponent(s.password)):"")));let c;if(u.isFormData(a)){if($.hasStandardBrowserEnv||$.hasStandardBrowserWebWorkerEnv)o.setContentType(void 0);else if((c=o.getContentType())!==!1){const[d,...l]=c?c.split(";").map(v=>v.trim()).filter(Boolean):[];o.setContentType([d||"multipart/form-data",...l].join("; "))}}if($.hasStandardBrowserEnv&&(t&&u.isFunction(t)&&(t=t(n)),t||t!==!1&&Mr(n.url))){const d=i&&r&&Ur.read(r);d&&o.set(i,d)}return n},Vr=typeof XMLHttpRequest<"u",Hr=Vr&&function(e){return new Promise(function(n,a){const t=ht(e);let i=t.data;const r=z.from(t.headers).normalize();let{responseType:o}=t,s;function c(){t.cancelToken&&t.cancelToken.unsubscribe(s),t.signal&&t.signal.removeEventListener("abort",s)}let d=new XMLHttpRequest;d.open(t.method.toUpperCase(),t.url,!0),d.timeout=t.timeout;function l(){if(!d)return;const j=z.from("getAllResponseHeaders"in d&&d.getAllResponseHeaders()),p={data:!o||o==="text"||o==="json"?d.responseText:d.response,status:d.status,statusText:d.statusText,headers:j,config:e,request:d};jt(function(m){n(m),c()},function(m){a(m),c()},p),d=null}"onloadend"in d?d.onloadend=l:d.onreadystatechange=function(){!d||d.readyState!==4||d.status===0&&!(d.responseURL&&d.responseURL.indexOf("file:")===0)||setTimeout(l)},d.onabort=function(){d&&(a(new h("Request aborted",h.ECONNABORTED,t,d)),d=null)},d.onerror=function(){a(new h("Network Error",h.ERR_NETWORK,t,d)),d=null},d.ontimeout=function(){let j=t.timeout?"timeout of "+t.timeout+"ms exceeded":"timeout exceeded";const p=t.transitional||vt;t.timeoutErrorMessage&&(j=t.timeoutErrorMessage),a(new h(j,p.clarifyTimeoutError?h.ETIMEDOUT:h.ECONNABORTED,t,d)),d=null},i===void 0&&r.setContentType(null),"setRequestHeader"in d&&u.forEach(r.toJSON(),function(j,p){d.setRequestHeader(p,j)}),u.isUndefined(t.withCredentials)||(d.withCredentials=!!t.withCredentials),o&&o!=="json"&&(d.responseType=t.responseType),typeof t.onDownloadProgress=="function"&&d.addEventListener("progress",On(t.onDownloadProgress,!0)),typeof t.onUploadProgress=="function"&&d.upload&&d.upload.addEventListener("progress",On(t.onUploadProgress)),(t.cancelToken||t.signal)&&(s=j=>{d&&(a(!j||j.type?new on(null,e,d):j),d.abort(),d=null)},t.cancelToken&&t.cancelToken.subscribe(s),t.signal&&(t.signal.aborted?s():t.signal.addEventListener("abort",s)));const v=Pr(t.url);if(v&&$.protocols.indexOf(v)===-1){a(new h("Unsupported protocol "+v+":",h.ERR_BAD_REQUEST,e));return}d.send(i||null)})},Qr=(e,n)=>{let a=new AbortController,t;const i=function(c){if(!t){t=!0,o();const d=c instanceof Error?c:this.reason;a.abort(d instanceof h?d:new on(d instanceof Error?d.message:d))}};let r=n&&setTimeout(()=>{i(new h(`timeout ${n} of ms exceeded`,h.ETIMEDOUT))},n);const o=()=>{e&&(r&&clearTimeout(r),r=null,e.forEach(c=>{c&&(c.removeEventListener?c.removeEventListener("abort",i):c.unsubscribe(i))}),e=null)};e.forEach(c=>c&&c.addEventListener&&c.addEventListener("abort",i));const{signal:s}=a;return s.unsubscribe=o,[s,()=>{r&&clearTimeout(r),r=null}]},Xr=function*(e,n){let a=e.byteLength;if(a<n){yield e;return}let t=0,i;for(;t<a;)i=t+n,yield e.slice(t,i),t=i},Jr=async function*(e,n,a){for await(const t of e)yield*Xr(ArrayBuffer.isView(t)?t:await a(String(t)),n)},ja=(e,n,a,t,i)=>{const r=Jr(e,n,i);let o=0;return new ReadableStream({type:"bytes",async pull(s){const{done:c,value:d}=await r.next();if(c){s.close(),t();return}let l=d.byteLength;a&&a(o+=l),s.enqueue(new Uint8Array(d))},cancel(s){return t(s),r.return()}},{highWaterMark:2})},ma=(e,n)=>{const a=e!=null;return t=>setTimeout(()=>n({lengthComputable:a,total:e,loaded:t}))},Qn=typeof fetch=="function"&&typeof Request=="function"&&typeof Response=="function",ft=Qn&&typeof ReadableStream=="function",we=Qn&&(typeof TextEncoder=="function"?(e=>n=>e.encode(n))(new TextEncoder):async e=>new Uint8Array(await new Response(e).arrayBuffer())),Kr=ft&&(()=>{let e=!1;const n=new Request($.origin,{body:new ReadableStream,method:"POST",get duplex(){return e=!0,"half"}}).headers.has("Content-Type");return e&&!n})(),ha=64*1024,ke=ft&&!!(()=>{try{return u.isReadableStream(new Response("").body)}catch{}})(),Nn={stream:ke&&(e=>e.body)};Qn&&(e=>{["text","arrayBuffer","blob","formData","stream"].forEach(n=>{!Nn[n]&&(Nn[n]=u.isFunction(e[n])?a=>a[n]():(a,t)=>{throw new h(`Response type '${n}' is not supported`,h.ERR_NOT_SUPPORT,t)})})})(new Response);const Yr=async e=>{if(e==null)return 0;if(u.isBlob(e))return e.size;if(u.isSpecCompliantForm(e))return(await new Request(e).arrayBuffer()).byteLength;if(u.isArrayBufferView(e))return e.byteLength;if(u.isURLSearchParams(e)&&(e=e+""),u.isString(e))return(await we(e)).byteLength},Zr=async(e,n)=>u.toFiniteNumber(e.getContentLength())??Yr(n),no=Qn&&(async e=>{let{url:n,method:a,data:t,signal:i,cancelToken:r,timeout:o,onDownloadProgress:s,onUploadProgress:c,responseType:d,headers:l,withCredentials:v="same-origin",fetchOptions:j}=ht(e);d=d?(d+"").toLowerCase():"text";let[p,m]=i||r||o?Qr([i,r],o):[],f,k;const q=()=>{!f&&setTimeout(()=>{p&&p.unsubscribe()}),f=!0};let E;try{if(c&&Kr&&a!=="get"&&a!=="head"&&(E=await Zr(l,t))!==0){let y=new Request(n,{method:"POST",body:t,duplex:"half"}),_;u.isFormData(t)&&(_=y.headers.get("content-type"))&&l.setContentType(_),y.body&&(t=ja(y.body,ha,ma(E,On(c)),null,we))}u.isString(v)||(v=v?"cors":"omit"),k=new Request(n,{...j,signal:p,method:a.toUpperCase(),headers:l.normalize().toJSON(),body:t,duplex:"half",withCredentials:v});let b=await fetch(k);const dn=ke&&(d==="stream"||d==="response");if(ke&&(s||dn)){const y={};["status","statusText","headers"].forEach(U=>{y[U]=b[U]});const _=u.toFiniteNumber(b.headers.get("content-length"));b=new Response(ja(b.body,ha,s&&ma(_,On(s,!0)),dn&&q,we),y)}d=d||"text";let cn=await Nn[u.findKey(Nn,d)||"text"](b,e);return!dn&&q(),m&&m(),await new Promise((y,_)=>{jt(y,_,{data:cn,headers:z.from(b.headers),status:b.status,statusText:b.statusText,config:e,request:k})})}catch(b){throw q(),b&&b.name==="TypeError"&&/fetch/i.test(b.message)?Object.assign(new h("Network Error",h.ERR_NETWORK,e,k),{cause:b.cause||b}):h.from(b,b&&b.code,e,k)}}),xe={http:fr,xhr:Hr,fetch:no};u.forEach(xe,(e,n)=>{if(e){try{Object.defineProperty(e,"name",{value:n})}catch{}Object.defineProperty(e,"adapterName",{value:n})}});const fa=e=>`- ${e}`,eo=e=>u.isFunction(e)||e===null||e===!1,gt={getAdapter:e=>{e=u.isArray(e)?e:[e];const{length:n}=e;let a,t;const i={};for(let r=0;r<n;r++){a=e[r];let o;if(t=a,!eo(a)&&(t=xe[(o=String(a)).toLowerCase()],t===void 0))throw new h(`Unknown adapter '${o}'`);if(t)break;i[o||"#"+r]=t}if(!t){const r=Object.entries(i).map(([s,c])=>`adapter ${s} `+(c===!1?"is not supported by the environment":"is not available in the build"));let o=n?r.length>1?`since :
`+r.map(fa).join(`
`):" "+fa(r[0]):"as no adapter specified";throw new h("There is no suitable adapter to dispatch the request "+o,"ERR_NOT_SUPPORT")}return t},adapters:xe};function de(e){if(e.cancelToken&&e.cancelToken.throwIfRequested(),e.signal&&e.signal.aborted)throw new on(null,e)}function ga(e){return de(e),e.headers=z.from(e.headers),e.data=se.call(e,e.transformRequest),["post","put","patch"].indexOf(e.method)!==-1&&e.headers.setContentType("application/x-www-form-urlencoded",!1),gt.getAdapter(e.adapter||bn.adapter)(e).then(function(n){return de(e),n.data=se.call(e,e.transformResponse,n),n.headers=z.from(n.headers),n},function(n){return pt(n)||(de(e),n&&n.response&&(n.response.data=se.call(e,e.transformResponse,n.response),n.response.headers=z.from(n.response.headers))),Promise.reject(n)})}const yt="1.7.2",We={};["object","boolean","number","function","string","symbol"].forEach((e,n)=>{We[e]=function(a){return typeof a===e||"a"+(n<1?"n ":" ")+e}});const ya={};We.transitional=function(e,n,a){function t(i,r){return"[Axios v"+yt+"] Transitional option '"+i+"'"+r+(a?". "+a:"")}return(i,r,o)=>{if(e===!1)throw new h(t(r," has been removed"+(n?" in "+n:"")),h.ERR_DEPRECATED);return n&&!ya[r]&&(ya[r]=!0,console.warn(t(r," has been deprecated since v"+n+" and will be removed in the near future"))),e?e(i,r,o):!0}};function ao(e,n,a){if(typeof e!="object")throw new h("options must be an object",h.ERR_BAD_OPTION_VALUE);const t=Object.keys(e);let i=t.length;for(;i-- >0;){const r=t[i],o=n[r];if(o){const s=e[r],c=s===void 0||o(s,r,e);if(c!==!0)throw new h("option "+r+" must be "+c,h.ERR_BAD_OPTION_VALUE);continue}if(a!==!0)throw new h("Unknown option "+r,h.ERR_BAD_OPTION)}}const _e={assertOptions:ao,validators:We},W=_e.validators;let J=class{constructor(e){this.defaults=e,this.interceptors={request:new va,response:new va}}async request(e,n){try{return await this._request(e,n)}catch(a){if(a instanceof Error){let t;Error.captureStackTrace?Error.captureStackTrace(t={}):t=new Error;const i=t.stack?t.stack.replace(/^.+\n/,""):"";try{a.stack?i&&!String(a.stack).endsWith(i.replace(/^.+\n.+\n/,""))&&(a.stack+=`
`+i):a.stack=i}catch{}}throw a}}_request(e,n){typeof e=="string"?(n=n||{},n.url=e):n=e||{},n=Y(this.defaults,n);const{transitional:a,paramsSerializer:t,headers:i}=n;a!==void 0&&_e.assertOptions(a,{silentJSONParsing:W.transitional(W.boolean),forcedJSONParsing:W.transitional(W.boolean),clarifyTimeoutError:W.transitional(W.boolean)},!1),t!=null&&(u.isFunction(t)?n.paramsSerializer={serialize:t}:_e.assertOptions(t,{encode:W.function,serialize:W.function},!0)),n.method=(n.method||this.defaults.method||"get").toLowerCase();let r=i&&u.merge(i.common,i[n.method]);i&&u.forEach(["delete","get","head","post","put","patch","common"],p=>{delete i[p]}),n.headers=z.concat(r,i);const o=[];let s=!0;this.interceptors.request.forEach(function(p){typeof p.runWhen=="function"&&p.runWhen(n)===!1||(s=s&&p.synchronous,o.unshift(p.fulfilled,p.rejected))});const c=[];this.interceptors.response.forEach(function(p){c.push(p.fulfilled,p.rejected)});let d,l=0,v;if(!s){const p=[ga.bind(this),void 0];for(p.unshift.apply(p,o),p.push.apply(p,c),v=p.length,d=Promise.resolve(n);l<v;)d=d.then(p[l++],p[l++]);return d}v=o.length;let j=n;for(l=0;l<v;){const p=o[l++],m=o[l++];try{j=p(j)}catch(f){m.call(this,f);break}}try{d=ga.call(this,j)}catch(p){return Promise.reject(p)}for(l=0,v=c.length;l<v;)d=d.then(c[l++],c[l++]);return d}getUri(e){e=Y(this.defaults,e);const n=mt(e.baseURL,e.url);return lt(n,e.params,e.paramsSerializer)}};u.forEach(["delete","get","head","options"],function(e){J.prototype[e]=function(n,a){return this.request(Y(a||{},{method:e,url:n,data:(a||{}).data}))}});u.forEach(["post","put","patch"],function(e){function n(a){return function(t,i,r){return this.request(Y(r||{},{method:e,headers:a?{"Content-Type":"multipart/form-data"}:{},url:t,data:i}))}}J.prototype[e]=n(),J.prototype[e+"Form"]=n(!0)});let to=class bt{constructor(n){if(typeof n!="function")throw new TypeError("executor must be a function.");let a;this.promise=new Promise(function(i){a=i});const t=this;this.promise.then(i=>{if(!t._listeners)return;let r=t._listeners.length;for(;r-- >0;)t._listeners[r](i);t._listeners=null}),this.promise.then=i=>{let r;const o=new Promise(s=>{t.subscribe(s),r=s}).then(i);return o.cancel=function(){t.unsubscribe(r)},o},n(function(i,r,o){t.reason||(t.reason=new on(i,r,o),a(t.reason))})}throwIfRequested(){if(this.reason)throw this.reason}subscribe(n){if(this.reason){n(this.reason);return}this._listeners?this._listeners.push(n):this._listeners=[n]}unsubscribe(n){if(!this._listeners)return;const a=this._listeners.indexOf(n);a!==-1&&this._listeners.splice(a,1)}static source(){let n;return{token:new bt(function(a){n=a}),cancel:n}}};function io(e){return function(n){return e.apply(null,n)}}function ro(e){return u.isObject(e)&&e.isAxiosError===!0}const Ee={Continue:100,SwitchingProtocols:101,Processing:102,EarlyHints:103,Ok:200,Created:201,Accepted:202,NonAuthoritativeInformation:203,NoContent:204,ResetContent:205,PartialContent:206,MultiStatus:207,AlreadyReported:208,ImUsed:226,MultipleChoices:300,MovedPermanently:301,Found:302,SeeOther:303,NotModified:304,UseProxy:305,Unused:306,TemporaryRedirect:307,PermanentRedirect:308,BadRequest:400,Unauthorized:401,PaymentRequired:402,Forbidden:403,NotFound:404,MethodNotAllowed:405,NotAcceptable:406,ProxyAuthenticationRequired:407,RequestTimeout:408,Conflict:409,Gone:410,LengthRequired:411,PreconditionFailed:412,PayloadTooLarge:413,UriTooLong:414,UnsupportedMediaType:415,RangeNotSatisfiable:416,ExpectationFailed:417,ImATeapot:418,MisdirectedRequest:421,UnprocessableEntity:422,Locked:423,FailedDependency:424,TooEarly:425,UpgradeRequired:426,PreconditionRequired:428,TooManyRequests:429,RequestHeaderFieldsTooLarge:431,UnavailableForLegalReasons:451,InternalServerError:500,NotImplemented:501,BadGateway:502,ServiceUnavailable:503,GatewayTimeout:504,HttpVersionNotSupported:505,VariantAlsoNegotiates:506,InsufficientStorage:507,LoopDetected:508,NotExtended:510,NetworkAuthenticationRequired:511};Object.entries(Ee).forEach(([e,n])=>{Ee[n]=e});function wt(e){const n=new J(e),a=Ya(J.prototype.request,n);return u.extend(a,J.prototype,n,{allOwnKeys:!0}),u.extend(a,n,null,{allOwnKeys:!0}),a.create=function(t){return wt(Y(e,t))},a}const x=wt(bn);x.Axios=J;x.CanceledError=on;x.CancelToken=to;x.isCancel=pt;x.VERSION=yt;x.toFormData=Hn;x.AxiosError=h;x.Cancel=x.CanceledError;x.all=function(e){return Promise.all(e)};x.spread=io;x.isAxiosError=ro;x.mergeConfig=Y;x.AxiosHeaders=z;x.formToJSON=e=>ut(u.isHTMLForm(e)?new FormData(e):e);x.getAdapter=gt.getAdapter;x.HttpStatusCode=Ee;x.default=x;const{Axios:pv,AxiosError:jv,CanceledError:mv,isCancel:hv,CancelToken:fv,VERSION:gv,all:yv,Cancel:bv,isAxiosError:wv,spread:kv,toFormData:xv,AxiosHeaders:_v,HttpStatusCode:Ev,formToJSON:Sv,getAdapter:Cv,mergeConfig:Iv}=x;function oo(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var ce,ba;function so(){if(ba)return ce;ba=1;const e=new Set(["ENOTFOUND","ENETUNREACH","UNABLE_TO_GET_ISSUER_CERT","UNABLE_TO_GET_CRL","UNABLE_TO_DECRYPT_CERT_SIGNATURE","UNABLE_TO_DECRYPT_CRL_SIGNATURE","UNABLE_TO_DECODE_ISSUER_PUBLIC_KEY","CERT_SIGNATURE_FAILURE","CRL_SIGNATURE_FAILURE","CERT_NOT_YET_VALID","CERT_HAS_EXPIRED","CRL_NOT_YET_VALID","CRL_HAS_EXPIRED","ERROR_IN_CERT_NOT_BEFORE_FIELD","ERROR_IN_CERT_NOT_AFTER_FIELD","ERROR_IN_CRL_LAST_UPDATE_FIELD","ERROR_IN_CRL_NEXT_UPDATE_FIELD","OUT_OF_MEM","DEPTH_ZERO_SELF_SIGNED_CERT","SELF_SIGNED_CERT_IN_CHAIN","UNABLE_TO_GET_ISSUER_CERT_LOCALLY","UNABLE_TO_VERIFY_LEAF_SIGNATURE","CERT_CHAIN_TOO_LONG","CERT_REVOKED","INVALID_CA","PATH_LENGTH_EXCEEDED","INVALID_PURPOSE","CERT_UNTRUSTED","CERT_REJECTED","HOSTNAME_MISMATCH"]);return ce=n=>!e.has(n&&n.code),ce}var co=so();const lo=oo(co),Ge="axios-retry";function kt(e){const n=["ERR_CANCELED","ECONNABORTED"];return e.response||!e.code||n.includes(e.code)?!1:lo(e)}const xt=["get","head","options"],vo=xt.concat(["put","delete"]);function Ve(e){return e.code!=="ECONNABORTED"&&(!e.response||e.response.status===429||e.response.status>=500&&e.response.status<=599)}function uo(e){var n;return(n=e.config)!=null&&n.method?Ve(e)&&xt.indexOf(e.config.method)!==-1:!1}function _t(e){var n;return(n=e.config)!=null&&n.method?Ve(e)&&vo.indexOf(e.config.method)!==-1:!1}function Et(e){return kt(e)||_t(e)}function He(e=void 0){var n;const a=(n=e==null?void 0:e.response)==null?void 0:n.headers["retry-after"];if(!a)return 0;let t=(Number(a)||0)*1e3;return t===0&&(t=(new Date(a).valueOf()||0)-Date.now()),Math.max(0,t)}function po(e=0,n=void 0){return Math.max(0,He(n))}function jo(e=0,n=void 0,a=100){const t=2**e*a,i=Math.max(t,He(n)),r=i*.2*Math.random();return i+r}function mo(e=100){return(n=0,a=void 0)=>{const t=n*e;return Math.max(t,He(a))}}const ho={retries:3,retryCondition:Et,retryDelay:po,shouldResetTimeout:!1,onRetry:()=>{},onMaxRetryTimesExceeded:()=>{},validateResponse:null};function fo(e,n){return{...ho,...n,...e[Ge]}}function wa(e,n,a=!1){const t=fo(e,n||{});return t.retryCount=t.retryCount||0,(!t.lastRequestTime||a)&&(t.lastRequestTime=Date.now()),e[Ge]=t,t}function go(e,n){e.defaults.agent===n.agent&&delete n.agent,e.defaults.httpAgent===n.httpAgent&&delete n.httpAgent,e.defaults.httpsAgent===n.httpsAgent&&delete n.httpsAgent}async function yo(e,n){const{retries:a,retryCondition:t}=e,i=(e.retryCount||0)<a&&t(n);if(typeof i=="object")try{return await i!==!1}catch{return!1}return i}async function bo(e,n,a,t){var i;n.retryCount+=1;const{retryDelay:r,shouldResetTimeout:o,onRetry:s}=n,c=r(n.retryCount,a);if(go(e,t),!o&&t.timeout&&n.lastRequestTime){const d=Date.now()-n.lastRequestTime,l=t.timeout-d-c;if(l<=0)return Promise.reject(a);t.timeout=l}return t.transformRequest=[d=>d],await s(n.retryCount,a,t),(i=t.signal)!=null&&i.aborted?Promise.resolve(e(t)):new Promise(d=>{var l;const v=()=>{clearTimeout(j),d(e(t))},j=setTimeout(()=>{var p;d(e(t)),(p=t.signal)!=null&&p.removeEventListener&&t.signal.removeEventListener("abort",v)},c);(l=t.signal)!=null&&l.addEventListener&&t.signal.addEventListener("abort",v,{once:!0})})}async function wo(e,n){e.retryCount>=e.retries&&await e.onMaxRetryTimesExceeded(n,e.retryCount)}const F=(e,n)=>{const a=e.interceptors.request.use(i=>{var r;return wa(i,n,!0),(r=i[Ge])!=null&&r.validateResponse&&(i.validateStatus=()=>!1),i}),t=e.interceptors.response.use(null,async i=>{var r;const{config:o}=i;if(!o)return Promise.reject(i);const s=wa(o,n);return i.response&&(r=s.validateResponse)!=null&&r.call(s,i.response)?i.response:await yo(s,i)?bo(e,s,i,o):(await wo(s,i),Promise.reject(i))});return{requestInterceptorId:a,responseInterceptorId:t}};F.isNetworkError=kt;F.isSafeRequestError=uo;F.isIdempotentRequestError=_t;F.isNetworkOrIdempotentRequestError=Et;F.exponentialDelay=jo;F.linearDelay=mo;F.isRetryableError=Ve;function Qe(){let e=x.create({timeout:15e3,headers:{post:{"Content-Type":"application/x-www-form-urlencoded"}}});return F(e,{retries:3,retryDelay:F.exponentialDelay,retryCondition:n=>F.isNetworkOrIdempotentRequestError(n)||n.response&&n.response.status>=500}),Ii(e),qi(e),zi(e),e}Qe();async function ko(e){try{const n=await fetch(e,{method:"HEAD"});return console.log("jser url 404",n.status,e),n.status===404}catch(n){return console.error("检查URL状态时发生错误:",n),!1}}let Xn=Qe();const xo="http://localhost:3001/";Xn.defaults.baseURL=xo;Xn.defaults.timeout=6e4;const _o=e=>Xn.post("/api/recognize",e),Eo=e=>Xn.get(`https://api.dictionaryapi.dev/api/v2/entries/en/${e}`),St="myWordBooks",ka="wordBooksInited";function Ct(){return JSON.parse(localStorage.getItem(St)||"[]")}function So(){localStorage.getItem(ka)||(localStorage.setItem(St,JSON.stringify(bi)),localStorage.setItem(ka,"1"))}function It(e){return`https://api.dictionaryapi.dev/media/pronunciations/en/${e}-us.mp3`}const Co=1e3;let vn={},en=[];async function Io(e){if(vn[e]){const a=en.indexOf(e);return a>-1&&en.splice(a,1),en.push(e),vn[e]}let n=0;for(;n<3;){let a=n>0?"-"+n:"",t=qo(e,a);if(!await ko(t)){if(vn[e]=t,en.push(e),en.length>Co){const i=en.shift();delete vn[i]}return t}n++}return vn[e]="",""}function qo(e,n=""){return`https://api.dictionaryapi.dev/media/pronunciations/en/${e}${n}-us.mp3`}function qt(e){const n=/([a-z]*\.\s[^a-z]*)/gi,a=e.match(n);return a?a.map(t=>t.trim()):[]}function Ro(){return Qe().get("https://v2.xxapi.cn/api/randomenglishwords")}const zo=Ei(e=>Eo(e));async function Rt(e){var a,t;let n=await zo(e);return(t=(a=n==null?void 0:n.data)==null?void 0:a[0])==null?void 0:t.phonetic}function w(e,n,a,t,i,r,o,s){var c=typeof e=="function"?e.options:e;return n&&(c.render=n,c.staticRenderFns=a,c._compiled=!0),r&&(c._scopeId="data-v-"+r),{exports:e,options:c}}const Ao={name:"ImageTagOverlay",props:["imageUrl","products"],data(){return{imgWidth:1,imgHeight:1,activeIdx:null,popupStyle:{}}},methods:{onImgLoad(){const e=this.$refs.img;this.imgWidth=e.naturalWidth,this.imgHeight=e.naturalHeight},getBoxStyle(e){const n=e.XMin/this.imgWidth*100,a=e.YMin/this.imgHeight*100,t=(e.XMax-e.XMin)/this.imgWidth*100,i=(e.YMax-e.YMin)/this.imgHeight*100;return{position:"absolute",left:n+"%",top:a+"%",width:t+"%",height:i+"%",border:"2px solid #f00",boxSizing:"border-box",cursor:"pointer",zIndex:10}},getScaleX(){const e=this.$refs.img;return e?e.width/this.imgWidth:1},getScaleY(){const e=this.$refs.img;return e?e.height/this.imgHeight:1},showInfo(e,n){this.activeIdx=e,this.popupStyle={position:"absolute",left:n.offsetX+10+"px",top:n.offsetY+10+"px",background:"#fff",border:"1px solid #ccc",padding:"8px",zIndex:100}}}};var To=function(){var n=this,a=n._self._c;return a("div",{staticStyle:{position:"relative",display:"inline-block"}},[a("img",{ref:"img",attrs:{src:n.imageUrl},on:{load:n.onImgLoad}}),n._l(n.products,function(t,i){return a("div",{key:i,staticClass:"tag-box",style:n.getBoxStyle(t),on:{click:function(r){return n.showInfo(i,r)}}},[a("span",{staticClass:"tag-label"},[n._v(n._s(t.Name))]),n.activeIdx===i?a("div",{staticClass:"tag-popup",style:n.popupStyle},[a("div",[a("strong",[n._v(n._s(t.Name))]),a("br"),n._v(" 分类: "+n._s(t.Parents)),a("br"),n._v(" 置信度: "+n._s(t.Confidence)+"% ")]),a("button",{on:{click:function(r){r.stopPropagation(),n.activeIdx=null}}},[n._v("关闭")])]):n._e()])})],2)},Do=[],Oo=w(Ao,To,Do,!1,null,"bf9ecad4");const No=Oo.exports,$o={name:"RecognitionResult",props:{imageUrl:String,products:Array},components:{ImageTagOverlay:No}};var Lo=function(){var n=this,a=n._self._c;return n.imageUrl&&n.products&&n.products.length?a("div",{staticClass:"card"},[a("ImageTagOverlay",{attrs:{"image-url":n.imageUrl,products:n.products}})],1):n._e()},Po=[],Fo=w($o,Lo,Po,!1,null,null);const Bo=Fo.exports,Mo={name:"Toast",props:{message:String,type:{type:String,default:"success"},visible:Boolean}};var Uo=function(){var n=this,a=n._self._c;return a("transition",{attrs:{name:"fade"}},[n.visible?a("div",{staticClass:"toast",class:n.type},[n.type==="loading"?a("span",{staticClass:"spinner"}):n._e(),a("span",[n._v(n._s(n.message))])]):n._e()])},Wo=[],Go=w(Mo,Uo,Wo,!1,null,"c3e7338b");const Vo=Go.exports;let Ho=M.extend(Vo),N=null,Se=null;function _n({message:e,type:n="success",duration:a=2e3}){N&&(N.$destroy(),document.body.removeChild(N.$el),N=null);let t=new Ho({propsData:{message:e,type:n,visible:!0}});t.$mount(),document.body.appendChild(t.$el),N=t,n!=="loading"&&(Se=setTimeout(()=>{t.visible=!1,setTimeout(()=>{t.$destroy(),document.body.contains(t.$el)&&document.body.removeChild(t.$el),N=null},300)},a))}function Qo(){N&&(N.visible=!1,setTimeout(()=>{N.$destroy(),document.body.removeChild(N.$el),N=null,Se&&clearTimeout(Se)},300))}const V={success(e,n){_n({message:e,type:"success",duration:n})},error(e,n){_n({message:e,type:"error",duration:n})},warning(e,n){_n({message:e,type:"warning",duration:n})},loading(e){_n({message:e,type:"loading",duration:999999})},hide:Qo};function Xo(e,n=800,a=1600,t=.8){return new Promise((i,r)=>{const o=new window.Image,s=new FileReader;s.onload=c=>{o.src=c.target.result},o.onload=()=>{let{width:c,height:d}=o;if(c<=n){i(o.src);return}const l=Math.min(n/c,a/d,1);c=c*l,d=d*l;const v=document.createElement("canvas");v.width=c,v.height=d,v.getContext("2d").drawImage(o,0,0,c,d),v.toBlob(p=>{const m=new FileReader;m.onload=f=>i(f.target.result),m.onerror=r,m.readAsDataURL(p)},"image/jpeg",t)},o.onerror=r,s.onerror=r,s.readAsDataURL(e)})}const Jo={name:"Recognize",components:{RecognitionResult:Bo},data(){return{imageUrl:"",products:[]}},methods:{triggerFileInput(){this.$refs.fileInput.click()},async onFileChange(e){const n=e.target.files[0];if(!n)return;const a=Math.min(window.innerWidth,800),t=a*2,i=await Xo(n,a,t,.8);this.onImageUploaded(i),this.$refs.fileInput.value=""},async onImageUploaded(e){var n,a,t;this.imageUrl=e,this.products=[];try{V.loading("识别中..");const i=await _o({ImageBase64:e});i.data.success?(V.success("识别成功"),((t=(a=(n=i==null?void 0:i.data)==null?void 0:n.data)==null?void 0:a.Products)==null?void 0:t.length)===0?V.error("没有识别到物体"):this.products=i.data.data.Products):V.error("识别失败")}catch{V.error("识别失败")}this.$forceUpdate()}},beforeMount(){this.$route.query.auto}};var Ko=function(){var n=this,a=n._self._c;return a("div",{staticClass:"recognize-page",attrs:{id:"app"}},[n._m(0),a("div",{staticClass:"recognize-card-group"},[a("div",{staticClass:"recognize-card upload-card"},[a("div",{staticClass:"upload-dropzone",on:{click:n.triggerFileInput}},[a("svg",{staticClass:"upload-icon",attrs:{width:"48",height:"48",viewBox:"0 0 48 48"}},[a("g",{attrs:{fill:"none",stroke:"#3578e5","stroke-width":"2.5"}},[a("rect",{attrs:{x:"6",y:"6",width:"36",height:"36",rx:"8","stroke-dasharray":"6 4"}}),a("path",{attrs:{d:"M24 16v16m0 0l-6-6m6 6l6-6","stroke-linecap":"round","stroke-linejoin":"round"}})])]),a("div",{staticClass:"upload-text"},[n._v("点击上传图片识别")])]),a("input",{ref:"fileInput",staticStyle:{display:"none"},attrs:{type:"file",accept:"image/*"},on:{change:n.onFileChange}})]),a("div",{staticClass:"recognize-card result-card"},[a("RecognitionResult",{attrs:{imageUrl:n.imageUrl,products:n.products}})],1)])])},Yo=[function(){var e=this,n=e._self._c;return n("div",{staticClass:"recognize-header"},[n("span",{staticClass:"recognize-title"},[e._v("图片识别")])])}],Zo=w(Jo,Ko,Yo,!1,null,"f0532bc8");const ns=Zo.exports;/*!
 * vuex v3.6.2
 * (c) 2021 Evan You
 * @license MIT
 */function es(e){var n=Number(e.version.split(".")[0]);if(n>=2)e.mixin({beforeCreate:t});else{var a=e.prototype._init;e.prototype._init=function(i){i===void 0&&(i={}),i.init=i.init?[t].concat(i.init):t,a.call(this,i)}}function t(){var i=this.$options;i.store?this.$store=typeof i.store=="function"?i.store():i.store:i.parent&&i.parent.$store&&(this.$store=i.parent.$store)}}var as=typeof window<"u"?window:typeof global<"u"?global:{},an=as.__VUE_DEVTOOLS_GLOBAL_HOOK__;function ts(e){an&&(e._devtoolHook=an,an.emit("vuex:init",e),an.on("vuex:travel-to-state",function(n){e.replaceState(n)}),e.subscribe(function(n,a){an.emit("vuex:mutation",n,a)},{prepend:!0}),e.subscribeAction(function(n,a){an.emit("vuex:action",n,a)},{prepend:!0}))}function is(e,n){return e.filter(n)[0]}function Ce(e,n){if(n===void 0&&(n=[]),e===null||typeof e!="object")return e;var a=is(n,function(i){return i.original===e});if(a)return a.copy;var t=Array.isArray(e)?[]:{};return n.push({original:e,copy:t}),Object.keys(e).forEach(function(i){t[i]=Ce(e[i],n)}),t}function sn(e,n){Object.keys(e).forEach(function(a){return n(e[a],a)})}function zt(e){return e!==null&&typeof e=="object"}function rs(e){return e&&typeof e.then=="function"}function os(e,n){return function(){return e(n)}}var P=function(n,a){this.runtime=a,this._children=Object.create(null),this._rawModule=n;var t=n.state;this.state=(typeof t=="function"?t():t)||{}},At={namespaced:{configurable:!0}};At.namespaced.get=function(){return!!this._rawModule.namespaced};P.prototype.addChild=function(n,a){this._children[n]=a};P.prototype.removeChild=function(n){delete this._children[n]};P.prototype.getChild=function(n){return this._children[n]};P.prototype.hasChild=function(n){return n in this._children};P.prototype.update=function(n){this._rawModule.namespaced=n.namespaced,n.actions&&(this._rawModule.actions=n.actions),n.mutations&&(this._rawModule.mutations=n.mutations),n.getters&&(this._rawModule.getters=n.getters)};P.prototype.forEachChild=function(n){sn(this._children,n)};P.prototype.forEachGetter=function(n){this._rawModule.getters&&sn(this._rawModule.getters,n)};P.prototype.forEachAction=function(n){this._rawModule.actions&&sn(this._rawModule.actions,n)};P.prototype.forEachMutation=function(n){this._rawModule.mutations&&sn(this._rawModule.mutations,n)};Object.defineProperties(P.prototype,At);var nn=function(n){this.register([],n,!1)};nn.prototype.get=function(n){return n.reduce(function(a,t){return a.getChild(t)},this.root)};nn.prototype.getNamespace=function(n){var a=this.root;return n.reduce(function(t,i){return a=a.getChild(i),t+(a.namespaced?i+"/":"")},"")};nn.prototype.update=function(n){Tt([],this.root,n)};nn.prototype.register=function(n,a,t){var i=this;t===void 0&&(t=!0);var r=new P(a,t);if(n.length===0)this.root=r;else{var o=this.get(n.slice(0,-1));o.addChild(n[n.length-1],r)}a.modules&&sn(a.modules,function(s,c){i.register(n.concat(c),s,t)})};nn.prototype.unregister=function(n){var a=this.get(n.slice(0,-1)),t=n[n.length-1],i=a.getChild(t);i&&i.runtime&&a.removeChild(t)};nn.prototype.isRegistered=function(n){var a=this.get(n.slice(0,-1)),t=n[n.length-1];return a?a.hasChild(t):!1};function Tt(e,n,a){if(n.update(a),a.modules)for(var t in a.modules){if(!n.getChild(t))return;Tt(e.concat(t),n.getChild(t),a.modules[t])}}var R,T=function(n){var a=this;n===void 0&&(n={}),!R&&typeof window<"u"&&window.Vue&&Nt(window.Vue);var t=n.plugins;t===void 0&&(t=[]);var i=n.strict;i===void 0&&(i=!1),this._committing=!1,this._actions=Object.create(null),this._actionSubscribers=[],this._mutations=Object.create(null),this._wrappedGetters=Object.create(null),this._modules=new nn(n),this._modulesNamespaceMap=Object.create(null),this._subscribers=[],this._watcherVM=new R,this._makeLocalGettersCache=Object.create(null);var r=this,o=this,s=o.dispatch,c=o.commit;this.dispatch=function(j,p){return s.call(r,j,p)},this.commit=function(j,p,m){return c.call(r,j,p,m)},this.strict=i;var d=this._modules.root.state;Jn(this,d,[],this._modules.root),Je(this,d),t.forEach(function(v){return v(a)});var l=n.devtools!==void 0?n.devtools:R.config.devtools;l&&ts(this)},Xe={state:{configurable:!0}};Xe.state.get=function(){return this._vm._data.$$state};Xe.state.set=function(e){};T.prototype.commit=function(n,a,t){var i=this,r=$n(n,a,t),o=r.type,s=r.payload,c={type:o,payload:s},d=this._mutations[o];d&&(this._withCommit(function(){d.forEach(function(v){v(s)})}),this._subscribers.slice().forEach(function(l){return l(c,i.state)}))};T.prototype.dispatch=function(n,a){var t=this,i=$n(n,a),r=i.type,o=i.payload,s={type:r,payload:o},c=this._actions[r];if(c){try{this._actionSubscribers.slice().filter(function(l){return l.before}).forEach(function(l){return l.before(s,t.state)})}catch{}var d=c.length>1?Promise.all(c.map(function(l){return l(o)})):c[0](o);return new Promise(function(l,v){d.then(function(j){try{t._actionSubscribers.filter(function(p){return p.after}).forEach(function(p){return p.after(s,t.state)})}catch{}l(j)},function(j){try{t._actionSubscribers.filter(function(p){return p.error}).forEach(function(p){return p.error(s,t.state,j)})}catch{}v(j)})})}};T.prototype.subscribe=function(n,a){return Dt(n,this._subscribers,a)};T.prototype.subscribeAction=function(n,a){var t=typeof n=="function"?{before:n}:n;return Dt(t,this._actionSubscribers,a)};T.prototype.watch=function(n,a,t){var i=this;return this._watcherVM.$watch(function(){return n(i.state,i.getters)},a,t)};T.prototype.replaceState=function(n){var a=this;this._withCommit(function(){a._vm._data.$$state=n})};T.prototype.registerModule=function(n,a,t){t===void 0&&(t={}),typeof n=="string"&&(n=[n]),this._modules.register(n,a),Jn(this,this.state,n,this._modules.get(n),t.preserveState),Je(this,this.state)};T.prototype.unregisterModule=function(n){var a=this;typeof n=="string"&&(n=[n]),this._modules.unregister(n),this._withCommit(function(){var t=Ke(a.state,n.slice(0,-1));R.delete(t,n[n.length-1])}),Ot(this)};T.prototype.hasModule=function(n){return typeof n=="string"&&(n=[n]),this._modules.isRegistered(n)};T.prototype.hotUpdate=function(n){this._modules.update(n),Ot(this,!0)};T.prototype._withCommit=function(n){var a=this._committing;this._committing=!0,n(),this._committing=a};Object.defineProperties(T.prototype,Xe);function Dt(e,n,a){return n.indexOf(e)<0&&(a&&a.prepend?n.unshift(e):n.push(e)),function(){var t=n.indexOf(e);t>-1&&n.splice(t,1)}}function Ot(e,n){e._actions=Object.create(null),e._mutations=Object.create(null),e._wrappedGetters=Object.create(null),e._modulesNamespaceMap=Object.create(null);var a=e.state;Jn(e,a,[],e._modules.root,!0),Je(e,a,n)}function Je(e,n,a){var t=e._vm;e.getters={},e._makeLocalGettersCache=Object.create(null);var i=e._wrappedGetters,r={};sn(i,function(s,c){r[c]=os(s,e),Object.defineProperty(e.getters,c,{get:function(){return e._vm[c]},enumerable:!0})});var o=R.config.silent;R.config.silent=!0,e._vm=new R({data:{$$state:n},computed:r}),R.config.silent=o,e.strict&&us(e),t&&(a&&e._withCommit(function(){t._data.$$state=null}),R.nextTick(function(){return t.$destroy()}))}function Jn(e,n,a,t,i){var r=!a.length,o=e._modules.getNamespace(a);if(t.namespaced&&(e._modulesNamespaceMap[o],e._modulesNamespaceMap[o]=t),!r&&!i){var s=Ke(n,a.slice(0,-1)),c=a[a.length-1];e._withCommit(function(){R.set(s,c,t.state)})}var d=t.context=ss(e,o,a);t.forEachMutation(function(l,v){var j=o+v;cs(e,j,l,d)}),t.forEachAction(function(l,v){var j=l.root?v:o+v,p=l.handler||l;ls(e,j,p,d)}),t.forEachGetter(function(l,v){var j=o+v;vs(e,j,l,d)}),t.forEachChild(function(l,v){Jn(e,n,a.concat(v),l,i)})}function ss(e,n,a){var t=n==="",i={dispatch:t?e.dispatch:function(r,o,s){var c=$n(r,o,s),d=c.payload,l=c.options,v=c.type;return(!l||!l.root)&&(v=n+v),e.dispatch(v,d)},commit:t?e.commit:function(r,o,s){var c=$n(r,o,s),d=c.payload,l=c.options,v=c.type;(!l||!l.root)&&(v=n+v),e.commit(v,d,l)}};return Object.defineProperties(i,{getters:{get:t?function(){return e.getters}:function(){return ds(e,n)}},state:{get:function(){return Ke(e.state,a)}}}),i}function ds(e,n){if(!e._makeLocalGettersCache[n]){var a={},t=n.length;Object.keys(e.getters).forEach(function(i){if(i.slice(0,t)===n){var r=i.slice(t);Object.defineProperty(a,r,{get:function(){return e.getters[i]},enumerable:!0})}}),e._makeLocalGettersCache[n]=a}return e._makeLocalGettersCache[n]}function cs(e,n,a,t){var i=e._mutations[n]||(e._mutations[n]=[]);i.push(function(o){a.call(e,t.state,o)})}function ls(e,n,a,t){var i=e._actions[n]||(e._actions[n]=[]);i.push(function(o){var s=a.call(e,{dispatch:t.dispatch,commit:t.commit,getters:t.getters,state:t.state,rootGetters:e.getters,rootState:e.state},o);return rs(s)||(s=Promise.resolve(s)),e._devtoolHook?s.catch(function(c){throw e._devtoolHook.emit("vuex:error",c),c}):s})}function vs(e,n,a,t){e._wrappedGetters[n]||(e._wrappedGetters[n]=function(r){return a(t.state,t.getters,r.state,r.getters)})}function us(e){e._vm.$watch(function(){return this._data.$$state},function(){},{deep:!0,sync:!0})}function Ke(e,n){return n.reduce(function(a,t){return a[t]},e)}function $n(e,n,a){return zt(e)&&e.type&&(a=n,n=e,e=e.type),{type:e,payload:n,options:a}}function Nt(e){R&&e===R||(R=e,es(R))}var Q=Zn(function(e,n){var a={};return Yn(n).forEach(function(t){var i=t.key,r=t.val;a[i]=function(){var s=this.$store.state,c=this.$store.getters;if(e){var d=ne(this.$store,"mapState",e);if(!d)return;s=d.context.state,c=d.context.getters}return typeof r=="function"?r.call(this,s,c):s[r]},a[i].vuex=!0}),a}),H=Zn(function(e,n){var a={};return Yn(n).forEach(function(t){var i=t.key,r=t.val;a[i]=function(){for(var s=[],c=arguments.length;c--;)s[c]=arguments[c];var d=this.$store.commit;if(e){var l=ne(this.$store,"mapMutations",e);if(!l)return;d=l.context.commit}return typeof r=="function"?r.apply(this,[d].concat(s)):d.apply(this.$store,[r].concat(s))}}),a}),I=Zn(function(e,n){var a={};return Yn(n).forEach(function(t){var i=t.key,r=t.val;r=e+r,a[i]=function(){if(!(e&&!ne(this.$store,"mapGetters",e)))return this.$store.getters[r]},a[i].vuex=!0}),a}),Kn=Zn(function(e,n){var a={};return Yn(n).forEach(function(t){var i=t.key,r=t.val;a[i]=function(){for(var s=[],c=arguments.length;c--;)s[c]=arguments[c];var d=this.$store.dispatch;if(e){var l=ne(this.$store,"mapActions",e);if(!l)return;d=l.context.dispatch}return typeof r=="function"?r.apply(this,[d].concat(s)):d.apply(this.$store,[r].concat(s))}}),a}),ps=function(e){return{mapState:Q.bind(null,e),mapGetters:I.bind(null,e),mapMutations:H.bind(null,e),mapActions:Kn.bind(null,e)}};function Yn(e){return js(e)?Array.isArray(e)?e.map(function(n){return{key:n,val:n}}):Object.keys(e).map(function(n){return{key:n,val:e[n]}}):[]}function js(e){return Array.isArray(e)||zt(e)}function Zn(e){return function(n,a){return typeof n!="string"?(a=n,n=""):n.charAt(n.length-1)!=="/"&&(n+="/"),e(n,a)}}function ne(e,n,a){var t=e._modulesNamespaceMap[a];return t}function ms(e){e===void 0&&(e={});var n=e.collapsed;n===void 0&&(n=!0);var a=e.filter;a===void 0&&(a=function(l,v,j){return!0});var t=e.transformer;t===void 0&&(t=function(l){return l});var i=e.mutationTransformer;i===void 0&&(i=function(l){return l});var r=e.actionFilter;r===void 0&&(r=function(l,v){return!0});var o=e.actionTransformer;o===void 0&&(o=function(l){return l});var s=e.logMutations;s===void 0&&(s=!0);var c=e.logActions;c===void 0&&(c=!0);var d=e.logger;return d===void 0&&(d=console),function(l){var v=Ce(l.state);typeof d>"u"||(s&&l.subscribe(function(j,p){var m=Ce(p);if(a(j,v,m)){var f=Ea(),k=i(j),q="mutation "+j.type+f;xa(d,q,n),d.log("%c prev state","color: #9E9E9E; font-weight: bold",t(v)),d.log("%c mutation","color: #03A9F4; font-weight: bold",k),d.log("%c next state","color: #4CAF50; font-weight: bold",t(m)),_a(d)}v=m}),c&&l.subscribeAction(function(j,p){if(r(j,p)){var m=Ea(),f=o(j),k="action "+j.type+m;xa(d,k,n),d.log("%c action","color: #03A9F4; font-weight: bold",f),_a(d)}}))}}function xa(e,n,a){var t=a?e.groupCollapsed:e.group;try{t.call(e,n)}catch{e.log(n)}}function _a(e){try{e.groupEnd()}catch{e.log("—— log end ——")}}function Ea(){var e=new Date;return" @ "+En(e.getHours(),2)+":"+En(e.getMinutes(),2)+":"+En(e.getSeconds(),2)+"."+En(e.getMilliseconds(),3)}function hs(e,n){return new Array(n+1).join(e)}function En(e,n){return hs("0",n-e.toString().length)+e}var $t={Store:T,install:Nt,version:"3.6.2",mapState:Q,mapMutations:H,mapGetters:I,mapActions:Kn,createNamespacedHelpers:ps,createLogger:ms};const fs={namespaced:!0,state:{wordBooks:Ct(),progress:{learnedArr:[]}},getters:{currentGroup:(e,n,a,t)=>{let i=t["cache/usr_learned_no_arr"];return Math.floor(i.length/a.setting.groupSize)},words:(e,n,a)=>{var t;return((t=a.cache.wordBooks[n.currentBookIdx])==null?void 0:t.words)||[]},currentBookIdx:(e,n,a,t)=>{let i=t["cache/usr_bookId"],r=a.cache.wordBooks.findIndex(o=>o.id===i);return r===-1?0:r},bookName:(e,n,a,t)=>{var i;return((i=a.cache.wordBooks[n.currentBookIdx])==null?void 0:i.name)||""},bookId:(e,n,a,t)=>{var i;return((i=a.cache.wordBooks[n.currentBookIdx])==null?void 0:i.id)||0},groupCount:(e,n,a,t)=>Math.ceil(n.words.length/a.setting.groupSize),progressPercent:(e,n,a,t)=>{let i=t["cache/usr_learned_no_arr"];return i.length>0?Math.round(i.length/n.words.length*100):0},progressText:(e,n)=>n.words.length>0?`${n.currentGroup+1} / ${n.groupCount}`:"",groupStart:(e,n,a,t)=>n.currentGroup*a.setting.groupSize,groupEnd:(e,n,a,t)=>Math.min(n.currentGroup*a.setting.groupSize+a.setting.groupSize,n.words.length),getGroupWords:(e,n,a,t)=>()=>{let i=t["cache/usr_learned_no_arr"];const r=n.groupStart,o=n.groupEnd,s=[];for(let c=r;c<o;c++)i.includes(c)||s.push(c);return console.log("[groupWords]",s,r,o,i),s},getRvGroupWords:(e,n,a,t)=>()=>t["cache/usr_learned_no_arr"]},mutations:{setCurrentBookIdx(e,n){},setWordBooks(e,n,a){a.cache.wordBooks=n}},actions:{moveToNextGroup({getters:e,state:n}){}}};function gs(e=document.documentElement){return e.requestFullscreen?e.requestFullscreen():e.webkitRequestFullscreen?e.webkitRequestFullscreen():e.msRequestFullscreen?e.msRequestFullscreen():e.mozRequestFullScreen?e.mozRequestFullScreen():Promise.reject(new Error("Fullscreen API is not supported"))}function ys(){return document.exitFullscreen?document.exitFullscreen():document.webkitExitFullscreen?document.webkitExitFullscreen():document.msExitFullscreen?document.msExitFullscreen():document.mozCancelFullScreen?document.mozCancelFullScreen():Promise.reject(new Error("Fullscreen API is not supported"))}const Ln="wpv_";function Ie(){return Object.keys(window.localStorage).filter(n=>n.startsWith(Ln))}function bs(){let e=Ie();if(e.length===0){let n=`${Ln}_${Date.now()}`;window.localStorage.setItem(n,"{}"),e=Ie()}return e}function Sa(){let e=Ie();return e.length===0?`${Ln}_${Date.now()}`:e[e.length-1]||`${Ln}_${Date.now()}`}function ws(e){return Va(window.localStorage.getItem(e)||"{}")}const ks=Si((e,n)=>{window.localStorage.setItem(e,JSON.stringify(n))},100),le="usr_bookId",ve="usr_progress",xs={namespaced:!0,state:{ver_list:bs(),curr_ver_key:Sa(),usr_data:ws(Sa()),wordBooks:Ct()},getters:{usr_bookIdx:(e,n)=>{let a=n.usr_bookId,t=e.wordBooks.findIndex(i=>i.id===a);return t===-1?0:t},set_usr_bookIdx:(e,n)=>a=>{console.log("[bookIdx]",a);let t=e.wordBooks[a].id||0;n.set_usr_bookId(t)},usr_bookId:e=>Dn(e.usr_data,le,e.wordBooks[0].id),usr_progress:e=>Dn(e.usr_data,ve,{}),usr_learned_no_arr(e,n){var t;let a=n.usr_progress;return console.log("[getters.usr_bookId]",n.usr_bookId),console.log("[progress]",a),((t=a[n.usr_bookId])==null?void 0:t.learned_no_arr)||[]},usr_learned_words(e,n){let a=n.usr_learned_no_arr,t=n.usr_bookId,i=e.wordBooks.find(o=>o.id===t),r=i.words.filter((o,s)=>a.includes(s));return console.log("[cache learned_words]",r,t,i,a,e.wordBooks),r},set_usr_bookId(e,n){return a=>{oa(e.usr_data,le,a),console.log("[set_usr_bookId state.usr_data]",e.usr_data),n.set_usr_data(e.usr_data)}},set_usr_progress(e,n){return a=>{oa(e.usr_data,ve,a),n.set_usr_data(e.usr_data)}},add_usr_learned_no(e,n){return a=>{let t=n.usr_learned_no_arr;t.push(a),n.set_usr_learned_no_arr(t)}},set_usr_learned_no_arr(e,n){return a=>{let t=ge(e.usr_data);t=Xa(t,{[le]:n.usr_bookId,[ve]:{[n.usr_bookId]:{learned_no_arr:a}}}),n.set_usr_data(t)}},set_usr_data(e,n){return a=>{e.usr_data=a,ks(e.curr_ver_key,a)}}},mutations:{set_usr_data(e,n){e.usr_data=n}},actions:{}},_s={namespaced:!0,state:{showDictionary:!1,autoPlayAudio:!1,enableShortcuts:!1,groupSize:10},mutations:{setShowDictionary(e,n){e.showDictionary=n}},getters:{showDictionary:e=>e.showDictionary,autoPlayAudio:e=>e.autoPlayAudio,enableShortcuts:e=>e.enableShortcuts,setGroupSize(e){return n=>{console.log("[size]",n),e.groupSize=n}}}};M.use($t);const g={DEFAULT:0,LEARNING:1,LEARNED:2,REVIEWING:3,REVIEWED:4},Lt=new $t.Store({state:{study_status:g.DEFAULT,cache_frozen:!1,isFullscreen:!1},mutations:{setCacheFrozen(e,n){e.cache_frozen=n},setStudyStatus(e,n){e.study_status=n},setIsFullscreen(e,n){e.isFullscreen=n,n?gs():ys()}},actions:{},getters:{cacheWrapper(e){return function(n){var a;e.cache_frozen||(a=n==null?void 0:n.apply)==null||a.call(n,this,arguments)}}},modules:{book:fs,cache:xs,setting:_s}}),Es={name:"WordsHeader",props:{title:String}};var Ss=function(){var n=this,a=n._self._c;return a("div",{staticClass:"words-header"},[a("span",{staticClass:"book-title",on:{click:function(t){return n.$emit("change")}}},[n._v(" "+n._s(n.title||"词库")+" "),a("svg",{staticClass:"arrow",attrs:{width:"16",height:"16",viewBox:"0 0 24 24"}},[a("path",{attrs:{d:"M6 10l6 6 6-6",stroke:"#3578e5","stroke-width":"2",fill:"none","stroke-linecap":"round"}})])])])},Cs=[],Is=w(Es,Ss,Cs,!1,null,"2079ff2d");const Pt=Is.exports,qs={name:"WordsProgress",props:{total:Number,current:Number},computed:{progressPercent(){let e=this.current/this.total||0;return Math.round(e*100)}}};var Rs=function(){var n=this,a=n._self._c;return a("div",{staticClass:"progress-bar-fixed"},[a("div",{staticClass:"progress-bar-bg"},[a("div",{staticClass:"progress-bar-fg",style:{width:n.progressPercent+"%"}})]),a("div",{staticClass:"progress-text"},[n._v(" "+n._s(n.current)+" / "+n._s(n.total)+" ")])])},zs=[],As=w(qs,Rs,zs,!1,null,"4487d368");const Ft=As.exports,Ts={name:"FinishModal",props:{visible:{type:Boolean,default:!1},bookName:{type:String,default:""},subtitle:{type:String,default:""},restartText:{type:String,default:"再来一轮"},homeText:{type:String,default:"休息一下"}}};var Ds=function(){var n=this,a=n._self._c;return n.visible?a("div",{staticClass:"finish-mask"},[a("div",{staticClass:"finish-modal"},[a("div",{staticClass:"finish-title"},[n._v("🎉 恭喜你！")]),a("div",{staticClass:"finish-desc"},[n._v(n._s(n.subtitle||`本轮词库「${n.bookName}」已全部学完`))]),a("div",{staticClass:"finish-actions"},[n.restartText?a("button",{staticClass:"finish-btn",on:{click:function(t){return n.$emit("restart")}}},[n._v(" "+n._s(n.restartText||"再来一轮")+" ")]):n._e(),n.homeText?a("button",{staticClass:"finish-btn home-btn",on:{click:function(t){return n.$emit("returnHome")}}},[n._v(" "+n._s(n.homeText||"休息一下")+" ")]):n._e()])])]):n._e()},Os=[],Ns=w(Ts,Ds,Os,!1,null,"cde6fa11");const $s=Ns.exports;let A=null;const Pn=(e={})=>(A&&A.$destroy(),new Promise(n=>{const a=M.extend($s);return A=new a({propsData:{visible:!0,bookName:e.bookName||"",subtitle:e.subtitle||"",restartText:e.restartText||"",homeText:e.homeText||""}}),A.$mount(),document.body.appendChild(A.$el),A.$on("restart",()=>{Ca(),n({success:!0,data:!0})}),A.$on("returnHome",()=>{Ca(),n({success:!0,data:!1})}),A})),Ca=()=>{A&&(A.visible=!1,setTimeout(()=>{A.$destroy(),A.$el.remove(),A=null},300))};let Bt=!1,Mt=()=>{Bt=!0,document.removeEventListener("mousedown",Mt)};document.addEventListener("mousedown",Mt);function Ye(e){Wt(e)}function Ls(){Ye("/word-app/audio/handsup.wav")}function Ps(){Ye("/word-app/audio/ohno.wav")}function Ut(){Ye("/word-app/audio/right.wav")}let G=null;function Wt(e,n=()=>{}){if(!Bt){n(!0);return}const a=new Audio(e);G&&(G==null||G.pause(),G==null||G.remove()),G=a,a.onended=()=>{n(!0)},a.onerror=t=>{console.error(t),n(!1)},a.play()}const Fs={name:"WaPhoneticAudio",props:{phonetic:{type:String,default:""},word:{type:String,default:""},audioUrl:{type:String,default:""},disabled:{type:Boolean,default:!1}},data(){return{isPlaying:!1}},computed:{isAudioUnavailable(){return!this.word&&!this.audioUrl},realAudioUrl(){return this.audioUrl?this.audioUrl:this.word?`https://dict.youdao.com/dictvoice?type=1&audio=${encodeURIComponent(this.word)}`:""}},methods:{playAudio(){console.log("playAudio",this.disabled,this.isAudioUnavailable,this.realAudioUrl),!(this.disabled||this.isAudioUnavailable)&&(this.isPlaying=!0,Wt(this.realAudioUrl,()=>{this.isPlaying=!1,console.log("playAudio end",this.disabled,this.isAudioUnavailable)}))}}};var Bs=function(){var n=this,a=n._self._c;return a("div",{staticClass:"wa-phonetic-audio",class:{disabled:n.isAudioUnavailable},on:{click:n.playAudio}},[a("span",{staticClass:"phonetic-text"},[n._v(n._s(n.phonetic))]),a("button",{staticClass:"audio-btn",class:{"is-playing":n.isPlaying},attrs:{disabled:n.isAudioUnavailable||n.disabled,title:n.isAudioUnavailable?"暂无发音":"播放发音"}},[a("svg",{staticStyle:{"font-size":"20px"},attrs:{viewBox:"0 0 24 24",width:"1em",height:"1em"}},[a("path",{attrs:{d:"M3 10v4h4l5 5V5L7 10H3zm13.5 2c0-1.77-1.02-3.29-2.5-4.03v8.06c1.48-.74 2.5-2.26 2.5-4.03z",fill:n.isAudioUnavailable||n.disabled?"#bbb":"#3578e5"}})]),a("span",{staticClass:"ripple"})])])},Ms=[],Us=w(Fs,Bs,Ms,!1,null,"51a04e20");const Gt=Us.exports,pn=/^[a-z0-9]+(-[a-z0-9]+)*$/,ee=(e,n,a,t="")=>{const i=e.split(":");if(e.slice(0,1)==="@"){if(i.length<2||i.length>3)return null;t=i.shift().slice(1)}if(i.length>3||!i.length)return null;if(i.length>1){const s=i.pop(),c=i.pop(),d={provider:i.length>0?i[0]:t,prefix:c,name:s};return n&&!Rn(d)?null:d}const r=i[0],o=r.split("-");if(o.length>1){const s={provider:t,prefix:o.shift(),name:o.join("-")};return n&&!Rn(s)?null:s}if(a&&t===""){const s={provider:t,prefix:"",name:r};return n&&!Rn(s,a)?null:s}return null},Rn=(e,n)=>e?!!((e.provider===""||e.provider.match(pn))&&(n&&e.prefix===""||e.prefix.match(pn))&&e.name.match(pn)):!1,Vt=Object.freeze({left:0,top:0,width:16,height:16}),Fn=Object.freeze({rotate:0,vFlip:!1,hFlip:!1}),Ht=Object.freeze({...Vt,...Fn}),qe=Object.freeze({...Ht,body:"",hidden:!1});function Ws(e,n){const a={};!e.hFlip!=!n.hFlip&&(a.hFlip=!0),!e.vFlip!=!n.vFlip&&(a.vFlip=!0);const t=((e.rotate||0)+(n.rotate||0))%4;return t&&(a.rotate=t),a}function Ia(e,n){const a=Ws(e,n);for(const t in qe)t in Fn?t in e&&!(t in a)&&(a[t]=Fn[t]):t in n?a[t]=n[t]:t in e&&(a[t]=e[t]);return a}function Gs(e,n){const a=e.icons,t=e.aliases||Object.create(null),i=Object.create(null);function r(o){if(a[o])return i[o]=[];if(!(o in i)){i[o]=null;const s=t[o]&&t[o].parent,c=s&&r(s);c&&(i[o]=[s].concat(c))}return i[o]}return Object.keys(a).concat(Object.keys(t)).forEach(r),i}function Vs(e,n,a){const t=e.icons,i=e.aliases||Object.create(null);let r={};function o(s){r=Ia(t[s]||i[s],r)}return o(n),a.forEach(o),Ia(e,r)}function Qt(e,n){const a=[];if(typeof e!="object"||typeof e.icons!="object")return a;e.not_found instanceof Array&&e.not_found.forEach(i=>{n(i,null),a.push(i)});const t=Gs(e);for(const i in t){const r=t[i];r&&(n(i,Vs(e,i,r)),a.push(i))}return a}const Hs={provider:"",aliases:{},not_found:{},...Vt};function ue(e,n){for(const a in n)if(a in e&&typeof e[a]!=typeof n[a])return!1;return!0}function Xt(e){if(typeof e!="object"||e===null)return null;const n=e;if(typeof n.prefix!="string"||!e.icons||typeof e.icons!="object"||!ue(e,Hs))return null;const a=n.icons;for(const i in a){const r=a[i];if(!i.match(pn)||typeof r.body!="string"||!ue(r,qe))return null}const t=n.aliases||Object.create(null);for(const i in t){const r=t[i],o=r.parent;if(!i.match(pn)||typeof o!="string"||!a[o]&&!t[o]||!ue(r,qe))return null}return n}const qa=Object.create(null);function Qs(e,n){return{provider:e,prefix:n,icons:Object.create(null),missing:new Set}}function Z(e,n){const a=qa[e]||(qa[e]=Object.create(null));return a[n]||(a[n]=Qs(e,n))}function Ze(e,n){return Xt(n)?Qt(n,(a,t)=>{t?e.icons[a]=t:e.missing.add(a)}):[]}function Xs(e,n,a){try{if(typeof a.body=="string")return e.icons[n]={...a},!0}catch{}return!1}let hn=!1;function Jt(e){return typeof e=="boolean"&&(hn=e),hn}function Js(e){const n=typeof e=="string"?ee(e,!0,hn):e;if(n){const a=Z(n.provider,n.prefix),t=n.name;return a.icons[t]||(a.missing.has(t)?null:void 0)}}function Ks(e,n){const a=ee(e,!0,hn);if(!a)return!1;const t=Z(a.provider,a.prefix);return Xs(t,a.name,n)}function Ys(e,n){if(typeof e!="object")return!1;if(typeof n!="string"&&(n=e.provider||""),hn&&!n&&!e.prefix){let i=!1;return Xt(e)&&(e.prefix="",Qt(e,(r,o)=>{o&&Ks(r,o)&&(i=!0)})),i}const a=e.prefix;if(!Rn({provider:n,prefix:a,name:"a"}))return!1;const t=Z(n,a);return!!Ze(t,e)}const Kt=Object.freeze({width:null,height:null}),Yt=Object.freeze({...Kt,...Fn}),Zs=/(-?[0-9.]*[0-9]+[0-9.]*)/g,nd=/^-?[0-9.]*[0-9]+[0-9.]*$/g;function Ra(e,n,a){if(n===1)return e;if(a=a||100,typeof e=="number")return Math.ceil(e*n*a)/a;if(typeof e!="string")return e;const t=e.split(Zs);if(t===null||!t.length)return e;const i=[];let r=t.shift(),o=nd.test(r);for(;;){if(o){const s=parseFloat(r);isNaN(s)?i.push(r):i.push(Math.ceil(s*n*a)/a)}else i.push(r);if(r=t.shift(),r===void 0)return i.join("");o=!o}}const ed=e=>e==="unset"||e==="undefined"||e==="none";function ad(e,n){const a={...Ht,...e},t={...Yt,...n},i={left:a.left,top:a.top,width:a.width,height:a.height};let r=a.body;[a,t].forEach(m=>{const f=[],k=m.hFlip,q=m.vFlip;let E=m.rotate;k?q?E+=2:(f.push("translate("+(i.width+i.left).toString()+" "+(0-i.top).toString()+")"),f.push("scale(-1 1)"),i.top=i.left=0):q&&(f.push("translate("+(0-i.left).toString()+" "+(i.height+i.top).toString()+")"),f.push("scale(1 -1)"),i.top=i.left=0);let b;switch(E<0&&(E-=Math.floor(E/4)*4),E=E%4,E){case 1:b=i.height/2+i.top,f.unshift("rotate(90 "+b.toString()+" "+b.toString()+")");break;case 2:f.unshift("rotate(180 "+(i.width/2+i.left).toString()+" "+(i.height/2+i.top).toString()+")");break;case 3:b=i.width/2+i.left,f.unshift("rotate(-90 "+b.toString()+" "+b.toString()+")");break}E%2===1&&(i.left!==i.top&&(b=i.left,i.left=i.top,i.top=b),i.width!==i.height&&(b=i.width,i.width=i.height,i.height=b)),f.length&&(r='<g transform="'+f.join(" ")+'">'+r+"</g>")});const o=t.width,s=t.height,c=i.width,d=i.height;let l,v;o===null?(v=s===null?"1em":s==="auto"?d:s,l=Ra(v,c/d)):(l=o==="auto"?c:o,v=s===null?Ra(l,d/c):s==="auto"?d:s);const j={},p=(m,f)=>{ed(f)||(j[m]=f.toString())};return p("width",l),p("height",v),j.viewBox=i.left.toString()+" "+i.top.toString()+" "+c.toString()+" "+d.toString(),{attributes:j,body:r}}const td=/\sid="(\S+)"/g,id="IconifyId"+Date.now().toString(16)+(Math.random()*16777216|0).toString(16);let rd=0;function od(e,n=id){const a=[];let t;for(;t=td.exec(e);)a.push(t[1]);if(!a.length)return e;const i="suffix"+(Math.random()*16777216|Date.now()).toString(16);return a.forEach(r=>{const o=typeof n=="function"?n(r):n+(rd++).toString(),s=r.replace(/[.*+?^${}()|[\]\\]/g,"\\$&");e=e.replace(new RegExp('([#;"])('+s+')([")]|\\.[a-z])',"g"),"$1"+o+i+"$3")}),e=e.replace(new RegExp(i,"g"),""),e}const Re=Object.create(null);function sd(e,n){Re[e]=n}function ze(e){return Re[e]||Re[""]}function na(e){let n;if(typeof e.resources=="string")n=[e.resources];else if(n=e.resources,!(n instanceof Array)||!n.length)return null;return{resources:n,path:e.path||"/",maxURL:e.maxURL||500,rotate:e.rotate||750,timeout:e.timeout||5e3,random:e.random===!0,index:e.index||0,dataAfterTimeout:e.dataAfterTimeout!==!1}}const ea=Object.create(null),un=["https://api.simplesvg.com","https://api.unisvg.com"],zn=[];for(;un.length>0;)un.length===1||Math.random()>.5?zn.push(un.shift()):zn.push(un.pop());ea[""]=na({resources:["https://api.iconify.design"].concat(zn)});function dd(e,n){const a=na(n);return a===null?!1:(ea[e]=a,!0)}function aa(e){return ea[e]}const cd=()=>{let e;try{if(e=fetch,typeof e=="function")return e}catch{}};let za=cd();function ld(e,n){const a=aa(e);if(!a)return 0;let t;if(!a.maxURL)t=0;else{let i=0;a.resources.forEach(o=>{i=Math.max(i,o.length)});const r=n+".json?icons=";t=a.maxURL-i-a.path.length-r.length}return t}function vd(e){return e===404}const ud=(e,n,a)=>{const t=[],i=ld(e,n),r="icons";let o={type:r,provider:e,prefix:n,icons:[]},s=0;return a.forEach((c,d)=>{s+=c.length+1,s>=i&&d>0&&(t.push(o),o={type:r,provider:e,prefix:n,icons:[]},s=c.length),o.icons.push(c)}),t.push(o),t};function pd(e){if(typeof e=="string"){const n=aa(e);if(n)return n.path}return"/"}const jd=(e,n,a)=>{if(!za){a("abort",424);return}let t=pd(n.provider);switch(n.type){case"icons":{const r=n.prefix,s=n.icons.join(","),c=new URLSearchParams({icons:s});t+=r+".json?"+c.toString();break}case"custom":{const r=n.uri;t+=r.slice(0,1)==="/"?r.slice(1):r;break}default:a("abort",400);return}let i=503;za(e+t).then(r=>{const o=r.status;if(o!==200){setTimeout(()=>{a(vd(o)?"abort":"next",o)});return}return i=501,r.json()}).then(r=>{if(typeof r!="object"||r===null){setTimeout(()=>{r===404?a("abort",r):a("next",i)});return}setTimeout(()=>{a("success",r)})}).catch(()=>{a("next",i)})},md={prepare:ud,send:jd};function hd(e){const n={loaded:[],missing:[],pending:[]},a=Object.create(null);e.sort((i,r)=>i.provider!==r.provider?i.provider.localeCompare(r.provider):i.prefix!==r.prefix?i.prefix.localeCompare(r.prefix):i.name.localeCompare(r.name));let t={provider:"",prefix:"",name:""};return e.forEach(i=>{if(t.name===i.name&&t.prefix===i.prefix&&t.provider===i.provider)return;t=i;const r=i.provider,o=i.prefix,s=i.name,c=a[r]||(a[r]=Object.create(null)),d=c[o]||(c[o]=Z(r,o));let l;s in d.icons?l=n.loaded:o===""||d.missing.has(s)?l=n.missing:l=n.pending;const v={provider:r,prefix:o,name:s};l.push(v)}),n}function Zt(e,n){e.forEach(a=>{const t=a.loaderCallbacks;t&&(a.loaderCallbacks=t.filter(i=>i.id!==n))})}function fd(e){e.pendingCallbacksFlag||(e.pendingCallbacksFlag=!0,setTimeout(()=>{e.pendingCallbacksFlag=!1;const n=e.loaderCallbacks?e.loaderCallbacks.slice(0):[];if(!n.length)return;let a=!1;const t=e.provider,i=e.prefix;n.forEach(r=>{const o=r.icons,s=o.pending.length;o.pending=o.pending.filter(c=>{if(c.prefix!==i)return!0;const d=c.name;if(e.icons[d])o.loaded.push({provider:t,prefix:i,name:d});else if(e.missing.has(d))o.missing.push({provider:t,prefix:i,name:d});else return a=!0,!0;return!1}),o.pending.length!==s&&(a||Zt([e],r.id),r.callback(o.loaded.slice(0),o.missing.slice(0),o.pending.slice(0),r.abort))})}))}let gd=0;function yd(e,n,a){const t=gd++,i=Zt.bind(null,a,t);if(!n.pending.length)return i;const r={id:t,icons:n,callback:e,abort:i};return a.forEach(o=>{(o.loaderCallbacks||(o.loaderCallbacks=[])).push(r)}),i}function bd(e,n=!0,a=!1){const t=[];return e.forEach(i=>{const r=typeof i=="string"?ee(i,n,a):i;r&&t.push(r)}),t}var wd={resources:[],index:0,timeout:2e3,rotate:750,random:!1,dataAfterTimeout:!1};function kd(e,n,a,t){const i=e.resources.length,r=e.random?Math.floor(Math.random()*i):e.index;let o;if(e.random){let y=e.resources.slice(0);for(o=[];y.length>1;){const _=Math.floor(Math.random()*y.length);o.push(y[_]),y=y.slice(0,_).concat(y.slice(_+1))}o=o.concat(y)}else o=e.resources.slice(r).concat(e.resources.slice(0,r));const s=Date.now();let c="pending",d=0,l,v=null,j=[],p=[];typeof t=="function"&&p.push(t);function m(){v&&(clearTimeout(v),v=null)}function f(){c==="pending"&&(c="aborted"),m(),j.forEach(y=>{y.status==="pending"&&(y.status="aborted")}),j=[]}function k(y,_){_&&(p=[]),typeof y=="function"&&p.push(y)}function q(){return{startTime:s,payload:n,status:c,queriesSent:d,queriesPending:j.length,subscribe:k,abort:f}}function E(){c="failed",p.forEach(y=>{y(void 0,l)})}function b(){j.forEach(y=>{y.status==="pending"&&(y.status="aborted")}),j=[]}function dn(y,_,U){const xn=_!=="success";switch(j=j.filter(X=>X!==y),c){case"pending":break;case"failed":if(xn||!e.dataAfterTimeout)return;break;default:return}if(_==="abort"){l=U,E();return}if(xn){l=U,j.length||(o.length?cn():E());return}if(m(),b(),!e.random){const X=e.resources.indexOf(y.resource);X!==-1&&X!==e.index&&(e.index=X)}c="completed",p.forEach(X=>{X(U)})}function cn(){if(c!=="pending")return;m();const y=o.shift();if(y===void 0){if(j.length){v=setTimeout(()=>{m(),c==="pending"&&(b(),E())},e.timeout);return}E();return}const _={status:"pending",resource:y,callback:(U,xn)=>{dn(_,U,xn)}};j.push(_),d++,v=setTimeout(cn,e.rotate),a(y,n,_.callback)}return setTimeout(cn),q}function ni(e){const n={...wd,...e};let a=[];function t(){a=a.filter(s=>s().status==="pending")}function i(s,c,d){const l=kd(n,s,c,(v,j)=>{t(),d&&d(v,j)});return a.push(l),l}function r(s){return a.find(c=>s(c))||null}return{query:i,find:r,setIndex:s=>{n.index=s},getIndex:()=>n.index,cleanup:t}}function Aa(){}const pe=Object.create(null);function xd(e){if(!pe[e]){const n=aa(e);if(!n)return;const a=ni(n),t={config:n,redundancy:a};pe[e]=t}return pe[e]}function _d(e,n,a){let t,i;if(typeof e=="string"){const r=ze(e);if(!r)return a(void 0,424),Aa;i=r.send;const o=xd(e);o&&(t=o.redundancy)}else{const r=na(e);if(r){t=ni(r);const o=e.resources?e.resources[0]:"",s=ze(o);s&&(i=s.send)}}return!t||!i?(a(void 0,424),Aa):t.query(n,i,a)().abort}const Ta="iconify2",fn="iconify",ei=fn+"-count",Da=fn+"-version",ai=36e5,Ed=168;function Ae(e,n){try{return e.getItem(n)}catch{}}function ta(e,n,a){try{return e.setItem(n,a),!0}catch{}}function Oa(e,n){try{e.removeItem(n)}catch{}}function Te(e,n){return ta(e,ei,n.toString())}function De(e){return parseInt(Ae(e,ei))||0}const ae={local:!0,session:!0},ti={local:new Set,session:new Set};let ia=!1;function Sd(e){ia=e}let Sn=typeof window>"u"?{}:window;function ii(e){const n=e+"Storage";try{if(Sn&&Sn[n]&&typeof Sn[n].length=="number")return Sn[n]}catch{}ae[e]=!1}function ri(e,n){const a=ii(e);if(!a)return;const t=Ae(a,Da);if(t!==Ta){if(t){const s=De(a);for(let c=0;c<s;c++)Oa(a,fn+c.toString())}ta(a,Da,Ta),Te(a,0);return}const i=Math.floor(Date.now()/ai)-Ed,r=s=>{const c=fn+s.toString(),d=Ae(a,c);if(typeof d=="string"){try{const l=JSON.parse(d);if(typeof l=="object"&&typeof l.cached=="number"&&l.cached>i&&typeof l.provider=="string"&&typeof l.data=="object"&&typeof l.data.prefix=="string"&&n(l,s))return!0}catch{}Oa(a,c)}};let o=De(a);for(let s=o-1;s>=0;s--)r(s)||(s===o-1?(o--,Te(a,o)):ti[e].add(s))}function oi(){if(!ia){Sd(!0);for(const e in ae)ri(e,n=>{const a=n.data,t=n.provider,i=a.prefix,r=Z(t,i);if(!Ze(r,a).length)return!1;const o=a.lastModified||-1;return r.lastModifiedCached=r.lastModifiedCached?Math.min(r.lastModifiedCached,o):o,!0})}}function Cd(e,n){const a=e.lastModifiedCached;if(a&&a>=n)return a===n;if(e.lastModifiedCached=n,a)for(const t in ae)ri(t,i=>{const r=i.data;return i.provider!==e.provider||r.prefix!==e.prefix||r.lastModified===n});return!0}function Id(e,n){ia||oi();function a(t){let i;if(!ae[t]||!(i=ii(t)))return;const r=ti[t];let o;if(r.size)r.delete(o=Array.from(r).shift());else if(o=De(i),!Te(i,o+1))return;const s={cached:Math.floor(Date.now()/ai),provider:e.provider,data:n};return ta(i,fn+o.toString(),JSON.stringify(s))}n.lastModified&&!Cd(e,n.lastModified)||Object.keys(n.icons).length&&(n.not_found&&(n=Object.assign({},n),delete n.not_found),a("local")||a("session"))}function Na(){}function qd(e){e.iconsLoaderFlag||(e.iconsLoaderFlag=!0,setTimeout(()=>{e.iconsLoaderFlag=!1,fd(e)}))}function Rd(e,n){e.iconsToLoad?e.iconsToLoad=e.iconsToLoad.concat(n).sort():e.iconsToLoad=n,e.iconsQueueFlag||(e.iconsQueueFlag=!0,setTimeout(()=>{e.iconsQueueFlag=!1;const{provider:a,prefix:t}=e,i=e.iconsToLoad;delete e.iconsToLoad;let r;if(!i||!(r=ze(a)))return;r.prepare(a,t,i).forEach(s=>{_d(a,s,c=>{if(typeof c!="object")s.icons.forEach(d=>{e.missing.add(d)});else try{const d=Ze(e,c);if(!d.length)return;const l=e.pendingIcons;l&&d.forEach(v=>{l.delete(v)}),Id(e,c)}catch(d){console.error(d)}qd(e)})})}))}const zd=(e,n)=>{const a=bd(e,!0,Jt()),t=hd(a);if(!t.pending.length){let c=!0;return n&&setTimeout(()=>{c&&n(t.loaded,t.missing,t.pending,Na)}),()=>{c=!1}}const i=Object.create(null),r=[];let o,s;return t.pending.forEach(c=>{const{provider:d,prefix:l}=c;if(l===s&&d===o)return;o=d,s=l,r.push(Z(d,l));const v=i[d]||(i[d]=Object.create(null));v[l]||(v[l]=[])}),t.pending.forEach(c=>{const{provider:d,prefix:l,name:v}=c,j=Z(d,l),p=j.pendingIcons||(j.pendingIcons=new Set);p.has(v)||(p.add(v),i[d][l].push(v))}),r.forEach(c=>{const{provider:d,prefix:l}=c;i[d][l].length&&Rd(c,i[d][l])}),n?yd(n,t,r):Na};function Ad(e,n){const a={...e};for(const t in n){const i=n[t],r=typeof i;t in Kt?(i===null||i&&(r==="string"||r==="number"))&&(a[t]=i):r===typeof a[t]&&(a[t]=t==="rotate"?i%4:i)}return a}const Td=/[\s,]+/;function Dd(e,n){n.split(Td).forEach(a=>{switch(a.trim()){case"horizontal":e.hFlip=!0;break;case"vertical":e.vFlip=!0;break}})}function Od(e,n=0){const a=e.replace(/^-?[0-9.]*/,"");function t(i){for(;i<0;)i+=4;return i%4}if(a===""){const i=parseInt(e);return isNaN(i)?0:t(i)}else if(a!==e){let i=0;switch(a){case"%":i=25;break;case"deg":i=90}if(i){let r=parseFloat(e.slice(0,e.length-a.length));return isNaN(r)?0:(r=r/i,r%1===0?t(r):0)}}return n}const $a={...Yt,inline:!1},Nd={xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink","aria-hidden":!0,role:"img"},An={};["horizontal","vertical"].forEach(e=>{const n=e.slice(0,1)+"Flip";An[e+"-flip"]=n,An[e.slice(0,1)+"-flip"]=n,An[e+"Flip"]=n});const La=(e,n,a,t)=>{const i=Ad($a,n),r={...Nd},o={};for(let v in n){const j=n[v];if(j!==void 0)switch(v){case"icon":case"style":case"onLoad":break;case"inline":case"hFlip":case"vFlip":i[v]=j===!0||j==="true"||j===1;break;case"flip":typeof j=="string"&&Dd(i,j);break;case"color":o.color=j;break;case"rotate":typeof j=="string"?i[v]=Od(j):typeof j=="number"&&(i[v]=j);break;case"ariaHidden":case"aria-hidden":j!==!0&&j!=="true"&&delete r["aria-hidden"];break;default:const p=An[v];p?(j===!0||j==="true"||j===1)&&(i[p]=!0):$a[v]===void 0&&(r[v]=j)}}const s=ad(t,i);for(let v in s.attributes)r[v]=s.attributes[v];i.inline&&(o.verticalAlign="-0.125em");let c=0,d=n.id;typeof d=="string"&&(d=d.replace(/-/g,"_"));const l={attrs:r,domProps:{innerHTML:od(s.body,d?()=>d+"ID"+c++:"iconifyVue")}};return Object.keys(o).length>0&&(l.style=o),a&&(["on","ref"].forEach(v=>{a[v]!==void 0&&(l[v]=a[v])}),["staticClass","class"].forEach(v=>{a[v]!==void 0&&(l.class=a[v])})),e("svg",l)};Jt(!0);sd("",md);if(typeof document<"u"&&typeof window<"u"){oi();const e=window;if(e.IconifyPreload!==void 0){const n=e.IconifyPreload,a="Invalid IconifyPreload syntax.";typeof n=="object"&&n!==null&&(n instanceof Array?n:[n]).forEach(t=>{try{(typeof t!="object"||t===null||t instanceof Array||typeof t.icons!="object"||typeof t.prefix!="string"||!Ys(t))&&console.error(a)}catch{console.error(a)}})}if(e.IconifyProviders!==void 0){const n=e.IconifyProviders;if(typeof n=="object"&&n!==null)for(let a in n){const t="IconifyProviders["+a+"] is invalid.";try{const i=n[a];if(typeof i!="object"||!i||i.resources===void 0)continue;dd(a,i)||console.error(t)}catch{console.error(t)}}}}const $d={body:""},wn=M.extend({inheritAttrs:!1,data(){return{iconMounted:!1}},beforeMount(){this._name="",this._loadingIcon=null,this.iconMounted=!0},beforeDestroy(){this.abortLoading()},methods:{abortLoading(){this._loadingIcon&&(this._loadingIcon.abort(),this._loadingIcon=null)},getIcon(e,n){if(typeof e=="object"&&e!==null&&typeof e.body=="string")return this._name="",this.abortLoading(),{data:e};let a;if(typeof e!="string"||(a=ee(e,!1,!0))===null)return this.abortLoading(),null;const t=Js(a);if(!t)return(!this._loadingIcon||this._loadingIcon.name!==e)&&(this.abortLoading(),this._name="",t!==null&&(this._loadingIcon={name:e,abort:zd([a],()=>{this.$forceUpdate()})})),null;this.abortLoading(),this._name!==e&&(this._name=e,n&&n(e));const i=["iconify"];return a.prefix!==""&&i.push("iconify--"+a.prefix),a.provider!==""&&i.push("iconify--"+a.provider),{data:t,classes:i}}},render(e){const n=Object.assign({},this.$attrs);let a=this.$data;const t=this.iconMounted?this.getIcon(n.icon,n.onLoad):null;return t?(t.classes&&(a={...a,class:(typeof a.class=="string"?a.class+" ":"")+t.classes.join(" ")}),La(e,n,a,t.data)):La(e,n,a,$d)}}),Ld={name:"CardActions",components:{Icon:wn},props:{showIframeBtn:{type:Boolean,default:!1}},methods:{handlePass(){this.$emit("pass")},handleFail(){this.$emit("fail")},handleIframe(){this.$emit("iframe")}}};var Pd=function(){var n=this,a=n._self._c;return a("div",{staticClass:"card-actions"},[a("div",{staticClass:"action-btn pass-btn",attrs:{title:"已掌握"},on:{click:n.handlePass}},[a("Icon",{style:{color:"#4caf50"},attrs:{icon:"mdi:check",width:"28",height:"28"}})],1),a("div",{staticClass:"action-btn fail-btn",attrs:{title:"再看一次"},on:{click:n.handleFail}},[a("Icon",{style:{color:"#e55"},attrs:{icon:"mdi:close",width:"28",height:"28"}})],1)])},Fd=[],Bd=w(Ld,Pd,Fd,!1,null,"b91f9dec");const si=Bd.exports,ra={youdao:{name:"有道词典",nameEn:"Youdao Dictionary",url:"https://dict.youdao.com/result?word=",icon:"mdi:book-open-variant",color:"#1e88e5",description:"网易有道词典"},iciba:{name:"金山词霸",nameEn:"iCIBA",url:"https://www.iciba.com/word?w=",icon:"mdi:book-open-variant",color:"#1976d2",description:"金山词霸在线词典"},baidu:{name:"百度翻译",nameEn:"Baidu Translate",url:"https://fanyi.baidu.com/#en/zh/",icon:"mdi:book-open-variant",color:"#388e3c",description:"百度翻译词典"},sogou:{name:"搜狗翻译",nameEn:"Sogou Translate",url:"https://fanyi.sogou.com/text?keyword=",icon:"mdi:book-open-variant",color:"#7b1fa2",description:"搜狗翻译词典"},tencent:{name:"腾讯翻译",nameEn:"Tencent Translate",url:"https://fanyi.qq.com/translate?source=auto&target=zh&text=",icon:"mdi:book-open-variant",color:"#ff6f00",description:"腾讯翻译词典"},bing:{name:"必应词典",nameEn:"Bing Dictionary",url:"https://cn.bing.com/dict/search?q=",icon:"mdi:book-open-variant",color:"#c2185b",description:"微软必应词典"},dictcn:{name:"海词词典",nameEn:"Dict.cn",url:"https://dict.cn/",icon:"mdi:book-open-variant",color:"#d32f2f",description:"海词在线词典"},aiciba:{name:"爱词霸",nameEn:"AiCIBA",url:"https://www.aiciba.com/word?w=",icon:"mdi:book-open-variant",color:"#f57c00",description:"爱词霸在线词典"},cambridge:{name:"剑桥词典",nameEn:"Cambridge Dictionary",url:"https://dictionary.cambridge.org/dictionary/english/",icon:"mdi:book-open-variant",color:"#1e88e5",description:"剑桥大学权威英语词典",mayFail:!0,requiresVPN:!0},merriam:{name:"韦氏词典",nameEn:"Merriam-Webster",url:"https://www.merriam-webster.com/dictionary/",icon:"mdi:book-open-variant",color:"#388e3c",description:"美国韦氏词典",mayFail:!0,requiresVPN:!0}};function Md(e,n){const a=ra[e];if(!a)throw new Error(`未知的词典类型: ${e}`);return a.url+encodeURIComponent(n)}function je(e){const n=ra[e];return n?n.name:"未知词典"}function Ud(e){const n=ra[e];return n?n.icon:"mdi:book-open-variant"}function Wd(){return["youdao","iciba","bing","sogou","dictcn","aiciba"]}const Gd={name:"IframeModal",components:{Icon:wn},props:{visible:{type:Boolean,default:!1},url:{type:String,default:""},title:{type:String,default:""},showRefresh:{type:Boolean,default:!0},showUrlInput:{type:Boolean,default:!0},width:{type:String,default:"100vw"},height:{type:String,default:"100vh"},closeOnOverlay:{type:Boolean,default:!0}},data(){return{currentUrl:"",urlInput:"",loading:!1,loadTimeout:null,loadStartTime:null,loadDuration:0}},computed:{containerStyle(){return{maxWidth:this.width,maxHeight:this.height}}},watch:{visible(e){e?this.initModal():this.resetModal()},url:{immediate:!0,handler(e){e&&this.visible&&this.loadUrlFromProp(e)}}},methods:{initModal(){this.url&&this.loadUrlFromProp(this.url),document.body.style.overflow="hidden"},resetModal(){this.currentUrl="",this.urlInput="",this.loading=!1,this.clearLoadTimeout(),this.loadStartTime=null,this.loadDuration=0,document.body.style.overflow=""},loadUrlFromProp(e){this.currentUrl=e,this.urlInput=e,this.startLoading()},loadUrl(){const e=this.urlInput.trim();if(e){if(!this.isValidUrl(e)){this.$emit("error",{message:"请输入有效的网址"});return}this.currentUrl=e,this.startLoading(),this.$emit("url-change",e)}},refreshIframe(){if(this.currentUrl){this.startLoading();const e=this.$refs.iframeRef;e&&(e.src=this.currentUrl)}},startLoading(){this.loading=!0,this.loadStartTime=Date.now(),this.clearLoadTimeout(),this.loadTimeout=setTimeout(()=>{this.loading=!1,this.$emit("error",{message:"加载超时，请检查网络连接"})},3e4)},clearLoadTimeout(){this.loadTimeout&&(clearTimeout(this.loadTimeout),this.loadTimeout=null)},onIframeLoad(){this.loading=!1,this.clearLoadTimeout(),this.loadDuration=Date.now()-this.loadStartTime,this.$emit("loaded",this.currentUrl)},onIframeError(){this.loading=!1,this.clearLoadTimeout(),this.$emit("error",{message:"页面加载失败，请检查网址是否正确"})},closeModal(){this.$emit("update:visible",!1),this.$emit("close")},handleOverlayClick(){this.closeOnOverlay&&this.closeModal()},isValidUrl(e){try{return new URL(e),!0}catch{return!1}},getDisplayUrl(e){try{const n=new URL(e);return n.hostname+n.pathname}catch{return e}},cancelLoading(){this.loading=!1,this.clearLoadTimeout(),this.loadDuration=Date.now()-this.loadStartTime,console.log(`加载已取消，耗时: ${this.loadDuration}ms`),this.$emit("error",{message:"加载已取消"})}},beforeDestroy(){this.clearLoadTimeout(),document.body.style.overflow=""}};var Vd=function(){var n=this,a=n._self._c;return a("Transition",{attrs:{name:"modal-fade"}},[n.visible?a("div",{staticClass:"iframe-modal-overlay",on:{click:n.handleOverlayClick}},[a("div",{staticClass:"iframe-modal-container",style:n.containerStyle,on:{click:function(t){t.stopPropagation()}}},[n.loading?a("div",{staticClass:"iframe-loading-overlay"},[a("div",{staticClass:"loading-spinner"},[a("Icon",{staticClass:"spinning",attrs:{icon:"mdi:loading",width:"32",height:"32"}}),a("div",{staticClass:"loading-text"},[n._v("正在加载词典内容...")]),a("div",{staticClass:"loading-progress"},[a("div",{staticClass:"progress-bar"},[a("div",{staticClass:"progress-fill"})]),a("div",{staticClass:"progress-text"},[n._v("请稍候，这可能需要几秒钟")])]),a("button",{staticClass:"cancel-load-btn",attrs:{title:"取消加载"},on:{click:n.cancelLoading}},[a("Icon",{attrs:{icon:"mdi:close",width:"16",height:"16"}}),a("span",[n._v("取消加载")])],1)],1)]):n._e(),a("div",{staticClass:"iframe-container"},[n.currentUrl?a("iframe",{ref:"iframeRef",style:{opacity:n.loading?.3:1},attrs:{src:n.currentUrl,frameborder:"0",allowfullscreen:""},on:{load:n.onIframeLoad,error:n.onIframeError}}):a("div",{staticClass:"iframe-placeholder"},[a("Icon",{attrs:{icon:"mdi:web",width:"48",height:"48"}}),a("div",{staticClass:"placeholder-text"},[n._v("请输入要加载的网址")])],1)]),n.showUrlInput?a("div",{staticClass:"iframe-modal-footer"},[a("div",{staticClass:"url-input-container"},[a("input",{directives:[{name:"model",rawName:"v-model",value:n.urlInput,expression:"urlInput"}],staticClass:"url-input",attrs:{type:"url",placeholder:"请输入网址 (例如: https://example.com)"},domProps:{value:n.urlInput},on:{keyup:function(t){return!t.type.indexOf("key")&&n._k(t.keyCode,"enter",13,t.key,"Enter")?null:n.loadUrl.apply(null,arguments)},input:function(t){t.target.composing||(n.urlInput=t.target.value)}}}),a("button",{staticClass:"load-btn",attrs:{disabled:!n.urlInput.trim()},on:{click:n.loadUrl}},[n._v(" 加载 ")])])]):n._e(),a("div",{staticClass:"iframe-modal-header"},[a("div",{staticClass:"iframe-modal-title"},[n.title?a("span",[n._v(n._s(n.title))]):n.currentUrl?a("span",{staticClass:"url-display"},[n._v(n._s(n.getDisplayUrl(n.currentUrl)))]):n._e()]),a("div",{staticClass:"iframe-modal-actions"},[n.showRefresh?a("button",{staticClass:"action-btn refresh-btn",attrs:{title:"刷新页面"},on:{click:n.refreshIframe}},[a("Icon",{attrs:{icon:"mdi:refresh",width:"20",height:"20"}})],1):n._e(),a("button",{staticClass:"action-btn close-btn",attrs:{title:"关闭"},on:{click:n.closeModal}},[a("Icon",{attrs:{icon:"mdi:close",width:"20",height:"20"}})],1)])])])]):n._e()])},Hd=[],Qd=w(Gd,Vd,Hd,!1,null,"099836fd");const Xd=Qd.exports;class Jd{constructor(){this.instance=null,this.container=null}open(n={}){return new Promise(a=>{this.instance&&this.close(),this.container=document.createElement("div"),document.body.appendChild(this.container);const t=M.extend(Xd);this.instance=new t({propsData:{visible:!0,url:n.url||"",title:n.title||"",showRefresh:n.showRefresh!==!1,showUrlInput:n.showUrlInput!==!1,width:n.width||"100vw",height:n.height||"100vh",closeOnOverlay:n.closeOnOverlay!==!1}}),this.instance.$on("loaded",n.onLoaded),this.instance.$on("error",n.onError),this.instance.$on("url-change",n.onUrlChange),this.instance.$on("close",()=>{this.close(),a()}),this.instance.$on("update:visible",i=>{i||(this.close(),a())}),this.instance.$mount(this.container)})}close(){this.instance&&(document.body.removeChild(this.instance.$el),this.instance.$destroy(),this.instance=null)}isOpen(){return!!this.instance}}const Kd=new Jd,Yd=e=>Kd.open(e),Zd={name:"DictionaryLinks",components:{Icon:wn},props:{word:{type:String,required:!0}},computed:{dictionaries(){return Wd()}},methods:{getDictionaryName(e){return je(e)},getDictionaryIcon(e){return Ud(e)},handleDictionaryClick(e){this.openDictionary(e,this.word)},async openDictionary(e,n){if(n)try{const a=Md(e,n),t=je(e),i=`${t} - ${n}`;await Yd({url:a,title:i,showRefresh:!0,showUrlInput:!1,width:"100vw",height:"80vh",onLoaded:()=>{},onError:r=>{r.message.includes("frame-ancestors")||r.message.includes("CSP")?alert(e==="cambridge"||e==="merriam"?`${t}不支持在iframe中显示。

建议：
1. 尝试其他国内词典
2. 或直接访问：${a}`:`${t}不支持在iframe中显示，请尝试其他词典。`):r.message.includes("加载已取消")||alert(`${t}加载失败: ${r.message}`)}})}catch(a){alert(`打开${je(e)}失败: ${a.message}`)}}}};var nc=function(){var n=this,a=n._self._c;return a("div",{staticClass:"dictionary-links"},[a("div",{staticClass:"dictionary-title"},[n._v("权威词典")]),a("div",{staticClass:"dictionary-buttons"},n._l(n.dictionaries,function(t){return a("button",{key:t,staticClass:"dict-btn",attrs:{title:n.getDictionaryName(t)},on:{click:function(i){return n.handleDictionaryClick(t)}}},[a("Icon",{attrs:{icon:n.getDictionaryIcon(t),width:"14",height:"14"}}),a("span",{staticClass:"dict-btn-text"},[n._v(n._s(n.getDictionaryName(t)))])],1)}),0)])},ec=[],ac=w(Zd,nc,ec,!1,null,"95fccca4");const di=ac.exports,tc={name:"SliderContainer",props:{items:{type:Array,required:!0},isAnimating:{type:Boolean,default:!1},deltaX:{type:Number,default:0}},methods:{getItemStyle(e){const n=(e-1)*100,a=this.deltaX/window.innerWidth*100;return{transform:`translateX(calc(${n}% + ${a}vw))`,transition:this.isAnimating?"transform 0.3s cubic-bezier(0.25, 0.8, 0.5, 1)":"none",zIndex:e===1?2:1,opacity:e===1?1:.5}}}};var ic=function(){var n=this,a=n._self._c;return a("div",{staticClass:"slider-container"},n._l(n.items,function(t,i){return a("div",{key:i,staticClass:"slider-item",class:{"is-current":i===1},style:n.getItemStyle(i)},[n._t("default",null,{item:t,index:i})],2)}),0)},rc=[],oc=w(tc,ic,rc,!1,null,"782c2f8a");const ci=oc.exports,Oe=(e,n)=>n.some(a=>e instanceof a);let Pa,Fa;function sc(){return Pa||(Pa=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function dc(){return Fa||(Fa=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const Ne=new WeakMap,me=new WeakMap,te=new WeakMap;function cc(e){const n=new Promise((a,t)=>{const i=()=>{e.removeEventListener("success",r),e.removeEventListener("error",o)},r=()=>{a(K(e.result)),i()},o=()=>{t(e.error),i()};e.addEventListener("success",r),e.addEventListener("error",o)});return te.set(n,e),n}function lc(e){if(Ne.has(e))return;const n=new Promise((a,t)=>{const i=()=>{e.removeEventListener("complete",r),e.removeEventListener("error",o),e.removeEventListener("abort",o)},r=()=>{a(),i()},o=()=>{t(e.error||new DOMException("AbortError","AbortError")),i()};e.addEventListener("complete",r),e.addEventListener("error",o),e.addEventListener("abort",o)});Ne.set(e,n)}let $e={get(e,n,a){if(e instanceof IDBTransaction){if(n==="done")return Ne.get(e);if(n==="store")return a.objectStoreNames[1]?void 0:a.objectStore(a.objectStoreNames[0])}return K(e[n])},set(e,n,a){return e[n]=a,!0},has(e,n){return e instanceof IDBTransaction&&(n==="done"||n==="store")?!0:n in e}};function li(e){$e=e($e)}function vc(e){return dc().includes(e)?function(...n){return e.apply(Le(this),n),K(this.request)}:function(...n){return K(e.apply(Le(this),n))}}function uc(e){return typeof e=="function"?vc(e):(e instanceof IDBTransaction&&lc(e),Oe(e,sc())?new Proxy(e,$e):e)}function K(e){if(e instanceof IDBRequest)return cc(e);if(me.has(e))return me.get(e);const n=uc(e);return n!==e&&(me.set(e,n),te.set(n,e)),n}const Le=e=>te.get(e);function vi(e,n,{blocked:a,upgrade:t,blocking:i,terminated:r}={}){const o=indexedDB.open(e,n),s=K(o);return t&&o.addEventListener("upgradeneeded",c=>{t(K(o.result),c.oldVersion,c.newVersion,K(o.transaction),c)}),a&&o.addEventListener("blocked",c=>a(c.oldVersion,c.newVersion,c)),s.then(c=>{r&&c.addEventListener("close",()=>r()),i&&c.addEventListener("versionchange",d=>i(d.oldVersion,d.newVersion,d))}).catch(()=>{}),s}const pc=["get","getKey","getAll","getAllKeys","count"],jc=["put","add","delete","clear"],he=new Map;function Ba(e,n){if(!(e instanceof IDBDatabase&&!(n in e)&&typeof n=="string"))return;if(he.get(n))return he.get(n);const a=n.replace(/FromIndex$/,""),t=n!==a,i=jc.includes(a);if(!(a in(t?IDBIndex:IDBObjectStore).prototype)||!(i||pc.includes(a)))return;const r=async function(o,...s){const c=this.transaction(o,i?"readwrite":"readonly");let d=c.store;return t&&(d=d.index(s.shift())),(await Promise.all([d[a](...s),i&&c.done]))[0]};return he.set(n,r),r}li(e=>({...e,get:(n,a,t)=>Ba(n,a)||e.get(n,a,t),has:(n,a)=>!!Ba(n,a)||e.has(n,a)}));const mc=["continue","continuePrimaryKey","advance"],Ma={},Pe=new WeakMap,ui=new WeakMap,hc={get(e,n){if(!mc.includes(n))return e[n];let a=Ma[n];return a||(a=Ma[n]=function(...t){Pe.set(this,ui.get(this)[n](...t))}),a}};async function*fc(...e){let n=this;if(n instanceof IDBCursor||(n=await n.openCursor(...e)),!n)return;n=n;const a=new Proxy(n,hc);for(ui.set(a,n),te.set(a,Le(n));n;)yield a,n=await(Pe.get(a)||n.continue()),Pe.delete(a)}function Ua(e,n){return n===Symbol.asyncIterator&&Oe(e,[IDBIndex,IDBObjectStore,IDBCursor])||n==="iterate"&&Oe(e,[IDBIndex,IDBObjectStore])}li(e=>({...e,get(n,a,t){return Ua(n,a)?fc:e.get(n,a,t)},has(n,a){return Ua(n,a)||e.has(n,a)}}));function gc(){return{EF:2.5,interval:0,repetitions:0}}function yc({EF:e,interval:n,repetitions:a},t){return t?(a+=1,a===1?n=1:a===2?n=6:n=Math.round(n*e),e=Math.min(2.5,e+.1)):(a=0,n=1,e=Math.max(1.3,e-.2)),{EF:e,interval:n,repetitions:a}}const B={FAIL:0,PASS:1},Tn={LEARNING:0,REVIEW:1},C={WORD:"word",TIMESTAMP:"timestamp",STATUS:"status",UID:"uid",TYPE:"type"};class bc{constructor(){this.dbName="wordAppRecordDB",this.storeName="wordRecords",this.version=1}async initDB(){return vi(this.dbName,this.version,{upgrade(n){if(!n.objectStoreNames.contains("wordRecords")){const a=n.createObjectStore("wordRecords",{keyPath:"id",autoIncrement:!0});a.createIndex("timestamp","timestamp",{unique:!1}),a.createIndex("word","word",{unique:!1})}}})}addNewRecord(n,a,t=0,i=Tn.LEARNING){const r={[C.WORD]:n,[C.TIMESTAMP]:Date.now(),[C.STATUS]:a,[C.UID]:t,[C.TYPE]:i};return this.addRecord(r)}async addRecord(n){return(await this.initDB()).add(this.storeName,n)}async getRecordsByUid(n){return(await this.initDB()).transaction(this.storeName).store.index("uid").getAll(n)}async getRecordsByWord(n){return(await this.initDB()).transaction(this.storeName).store.index("word").getAll(n)}async getRecordsByTimeRange(n,a){return(await this.initDB()).transaction(this.storeName).store.index("timestamp").getAll(IDBKeyRange.bound(n,a))}async deleteRecord(n){return(await this.initDB()).delete(this.storeName,n)}async clearAllRecords(){return(await this.initDB()).clear(this.storeName)}async getAllRecords(){return(await this.initDB()).getAll(this.storeName)}async updateRecord(n){return(await this.initDB()).put(this.storeName,n)}async generateTestData(){await this.clearAllRecords();const n=["apple","banana","orange","grape","watermelon","computer","phone","laptop","tablet","keyboard","book","pen","pencil","notebook","dictionary","student","teacher","school","university","classroom","house","building","apartment","room","kitchen"],a=new Date,t=[];for(let s=0;s<30;s++){const c=new Date(a);c.setDate(c.getDate()-s);const d=Math.floor(Math.random()*11)+5,l=n.sort(()=>Math.random()-.5).slice(0,d);for(const v of l){const j=Math.random()>.3?B.PASS:B.FAIL,p=new Date(c);if(p.setHours(Math.floor(Math.random()*12)+8),t.push({[C.WORD]:v,[C.TIMESTAMP]:p.getTime(),[C.STATUS]:j,[C.UID]:0,[C.TYPE]:Tn.LEARNING}),j===B.PASS){const m=new Date(p);m.setHours(m.getHours()+Math.floor(Math.random()*4)+1);const f=Math.random()>.2?B.PASS:B.FAIL;t.push({[C.WORD]:v,[C.TIMESTAMP]:m.getTime(),[C.STATUS]:f,[C.UID]:0,[C.TYPE]:Tn.REVIEW})}}}t.sort((s,c)=>s.timestamp-c.timestamp);const r=(await this.initDB()).transaction(this.storeName,"readwrite"),o=r.objectStore(this.storeName);for(const s of t)await o.add(s);await r.done,console.log("测试数据生成完成，共生成",t.length,"条记录")}}const Bn=new bc;function wc(e){return console.log("addPassWordRecord",e),Bn.addNewRecord(e,B.PASS)}function kc(e){return console.log("addFailWordRecord",e),Bn.addNewRecord(e,B.FAIL)}const xc={INITIAL_EF:2.5},S={WORD:"word",EF:"EF",INTERVAL:"interval",REPETITIONS:"repetitions",NEXT_REVIEW:"next_review"};class _c{constructor(){this.dbName="wordReviewDB",this.storeName="words",this.db=null,this.version=3}async init(){this.db||(this.db=await vi(this.dbName,this.version,{upgrade(n){n.objectStoreNames.contains("words")||n.createObjectStore("words",{keyPath:S.WORD}).createIndex(S.NEXT_REVIEW,S.NEXT_REVIEW,{unique:!1})}}))}async addWord(n){const a={[S.WORD]:n,[S.EF]:xc.INITIAL_EF,[S.INTERVAL]:0,[S.REPETITIONS]:0,[S.NEXT_REVIEW]:Date.now()};return this.putWord(a)}async putWord(n){return this.db.put(this.storeName,n)}async getWordsToReview(){return await this.init(),this.db.transaction(this.storeName,"readonly").store.index(S.NEXT_REVIEW).getAll(IDBKeyRange.upperBound(Date.now()))}async processReview(n,a){let t=await this.getWord(n)||gc();const{[S.EF]:i,[S.INTERVAL]:r,[S.REPETITIONS]:o}=t;let{EF:s,interval:c,repetitions:d}=yc({EF:i,interval:r,repetitions:o},!!a);const l={...t,[S.EF]:s,[S.INTERVAL]:c,[S.REPETITIONS]:d,[S.NEXT_REVIEW]:Date.now()+r*24*60*60*1e3,[S.WORD]:n};return console.log("updatedWordData",l),await this.putWord(l),l}async getWord(n){return await this.init(),this.db.get(this.storeName,n)}async getWords(n){return await this.init(),await Promise.all(n.map(a=>this.getWord(a)))}async getAllWords(){return await this.init(),this.db.getAll(this.storeName)}async deleteWord(n){return await this.init(),this.db.delete(this.storeName,n)}}const ie=new _c;ie.init();async function pi(e){return wc(e),await ie.processReview(e,1)}async function ji(e){return kc(e),await ie.processReview(e,0)}const Ec={bind(e,n,a){const t=a.context,{value:i}=n,r=o=>{if(!i)return;const s=Array.isArray(i)?i:[i];for(const{key:c,handler:d}of s)if(c&&d&&o.key===c){o.preventDefault(),d.call(t);break}};e._keyboardHandler=r,window.addEventListener("keydown",r)},unbind(e){window.removeEventListener("keydown",e._keyboardHandler),delete e._keyboardHandler}},Sc={name:"Words",components:{WordsHeader:Pt,WordsProgress:Ft,WaPhoneticAudio:Gt,CardActions:si,DictionaryLinks:di,SliderContainer:ci},directives:{keyboard:Ec},data(){return{touchStartX:0,deltaX:0,isDragging:!1,isAnimating:!1,learningQueue:[],currentIdx:0,revealedSet:new Set,phonetic:""}},watch:{currentIdx(){}},computed:{curr_learning_word(){let e=this.learningQueue[this.currentIdx];return this.words[e].en},...I("cache",["add_usr_learned_no"]),...Q("book",["currentBookIdx","wordBooks","words","GROUP_SIZE","currentGroup"]),...I("cache",["usr_learned_no_arr"]),...I("book",["bookName","bookId","groupCount","groupStart","groupEnd","getGroupWords"]),currWord(){return this.sliderWords[1]},sliderWords(){const e=this.learningQueue[this.currentIdx-1],n=this.learningQueue[this.currentIdx],a=this.learningQueue[this.currentIdx+1],t=i=>typeof i=="number"?this.words[i]||{en:"",zh:"",enDef:""}:{en:"",zh:"",enDef:""};return[t(e),t(n),t(a)]},...I("book",["progressPercent","progressText","words"]),isZhRevealed(){return this.revealedSet.has(this.learningQueue[this.currentIdx])},...I(["cacheWrapper"])},methods:{...H("book",["setCurrentBookIdx"]),...H(["setStudyStatus"]),getWordAudioUrl:It,splitTaggedText:qt,onTouchStart(e){this.isAnimating||this.learningQueue.length===0||(this.isDragging=!0,this.touchStartX=e.changedTouches[0].clientX,this.deltaX=0)},onTouchMove(e){if(!this.isDragging)return;const n=e.changedTouches[0].clientX-this.touchStartX;this.deltaX=n},async onTouchEnd(){if(!this.isDragging)return;this.isDragging=!1;const e=window.innerWidth/4;Math.abs(this.deltaX)>e&&(this.isAnimating=!0,this.deltaX>0?this.currentIdx>0?this.currentIdx--:this.currentIdx=this.learningQueue.length-1:this.currentIdx<this.learningQueue.length-1?this.currentIdx++:this.currentIdx=0,this.revealedSet.clear(),this.afterChange()),this.deltaX=0,await Un(300),this.isAnimating=!1},async afterChange(){this.phonetic="";let e=this.currWord;this.phonetic=await Rt((e==null?void 0:e.en)||""),console.log("this.phonetic",this.phonetic),this.playCurrentWord()},revealZh(){this.revealedSet.add(this.learningQueue[this.currentIdx]),this.revealedSet=new Set(this.revealedSet)},passWord(){if(!this.isZhRevealed){this.revealZh(),this.playCurrentWord();return}if(pi(this.curr_learning_word),this.learningQueue.length<=1){this.add_usr_learned_no(this.learningQueue[this.currentIdx]),this.nextGroupOrFinish();return}if(this.add_usr_learned_no(this.learningQueue[this.currentIdx]),this.learningQueue.splice(this.currentIdx,1),this.learningQueue.length===0){this.nextGroupOrFinish();return}this.currentIdx>=this.learningQueue.length&&(this.currentIdx=this.learningQueue.length-1),this.revealedSet.clear(),this.afterChange()},failWord(){if(!this.isZhRevealed){this.revealZh(),this.playCurrentWord();return}ji(this.curr_learning_word),this.currentIdx<this.learningQueue.length-1?this.currentIdx++:this.currentIdx=0,this.revealedSet.clear(),this.afterChange()},async nextGroupOrFinish(){if(this.usr_learned_no_arr.length>=this.words.length){Ls(),await this.openAllFinishModal();return}Ut(),await this.openGroupFinishModal()},async openAllFinishModal(){let e=await Pn({bookName:this.bookName});e.success&&(e.data?this.restartLearning():this.stopLearning())},async openGroupFinishModal(){let{currentGroup:e}=this,n=await Pn({bookName:`${this.bookName} - 第${e+1}组`,subtitle:"当前组已学完，是否继续下一组？",restartText:"继续下一组",homeText:"休息一下"});n.success&&(n.data?this.continueToNextGroup():this.stopAtCurrentGroup())},restartLearning(){this.currentGroup=0,this.initLearningQueue(),this.setStudyStatus(g.LEARNED)},continueToNextGroup(){this.moveToNextGroup(),this.initLearningQueue()},stopAtCurrentGroup(){this.setStudyStatus(g.LEARNED),gn()},initLearningQueue(){this.learningQueue=this.getGroupWords(),console.log("[this.learningQueue initLearningQueue]",this.learningQueue),this.currentIdx=0,this.revealedSet=new Set,this.deltaX=0,this.isDragging=!1,this.isAnimating=!1},...Kn("book",["loadBook","saveProgress","moveToNextGroup"]),loadProgress(){this.initLearningQueue(),this.afterChange()},stopLearning(){this.setStudyStatus(g.LEARNED),gn()},async openBookModal(){mi()},async playCurrentWord(){console.log("playCurrentWord",this.$refs.phonetic),this.$refs.phonetic.playAudio()},handlePrevWord(){this.isAnimating||this.learningQueue.length===0||(this.currentIdx>0?this.currentIdx--:this.currentIdx=this.learningQueue.length-1,this.revealedSet.clear(),this.afterChange())},handleNextWord(){this.isAnimating||this.learningQueue.length===0||(this.currentIdx<this.learningQueue.length-1?this.currentIdx++:this.currentIdx=0,this.revealedSet.clear(),this.afterChange())}},mounted(){this.loadProgress(),console.log("[this.learningQueue mounted]",this.learningQueue),this.learningQueue.length===0&&this.nextGroupOrFinish(),this.playCurrentWord()},beforeDestroy(){}};var Cc=function(){var n=this,a=n._self._c;return a("div",{directives:[{name:"keyboard",rawName:"v-keyboard",value:[{key:"ArrowLeft",handler:n.handlePrevWord},{key:"ArrowRight",handler:n.handleNextWord},{key:"Enter",handler:n.passWord},{key:"Escape",handler:n.failWord}],expression:`[
    ...
    ]`}],staticClass:"words-page",on:{touchstart:n.onTouchStart,touchmove:n.onTouchMove,touchend:n.onTouchEnd}},[a("WordsHeader",{attrs:{title:n.bookName},on:{change:n.openBookModal}}),a("WordsProgress",{directives:[{name:"show",rawName:"v-show",value:n.learningQueue.length>0,expression:"learningQueue.length > 0"}],attrs:{total:n.learningQueue.length,current:n.currentIdx+1}}),a("SliderContainer",{attrs:{items:n.sliderWords,isAnimating:n.isAnimating,deltaX:n.deltaX},scopedSlots:n._u([{key:"default",fn:function({item:t}){var i;return[a("div",{staticClass:"word-en"},[n._v(n._s(t.en))]),a("div",{staticStyle:{display:"flex","flex-wrap":"nowrap","align-items":"center",gap:"16px"}},[a("WaPhoneticAudio",{ref:"phonetic",attrs:{word:(i=n.currWord)==null?void 0:i.en,phonetic:n.phonetic}})],1),a("div",{staticClass:"word-zh",class:{mosaic:!n.isZhRevealed},on:{click:n.revealZh}},n._l(n.splitTaggedText(t.zh),function(r){return a("div",{key:r,staticClass:"word-zh-item"},[n._v(" "+n._s(r)+" ")])}),0),a("DictionaryLinks",{attrs:{word:t.en}})]}}])}),a("CardActions",{attrs:{showIframeBtn:!1},on:{pass:n.passWord,fail:n.failWord}})],1)},Ic=[],qc=w(Sc,Cc,Ic,!1,null,"34e88bca");const Rc=qc.exports,zc={name:"AudioButton",components:{Icon:wn},props:{word:{type:String,required:!0},title:{type:String,default:"播放发音"}},data(){return{isPlaying:!1,isLoading:!1,audioPlayer:null}},methods:{play(){this.handleClick()},async handleClick(){if(console.log("jser click"),!!this.word){this.audioPlayer&&this.audioPlayer.pause(),this.isLoading=!0;try{let e=await Io(this.word);if(!e){V.error("网络异常，请稍后重试");return}this.audioPlayer=new Audio(e),this.audioPlayer.addEventListener("ended",()=>{this.isPlaying=!1}),await this.audioPlayer.play(),this.isPlaying=!0}catch(e){console.error("Failed to play audio:",e),this.isPlaying=!1,V.error("播放失败，请稍后重试")}finally{this.isLoading=!1}}}},beforeDestroy(){this.audioPlayer&&(this.audioPlayer.pause(),this.audioPlayer.src="",this.audioPlayer=null),this.isPlaying=!1,this.isLoading=!1}};var Ac=function(){var n=this,a=n._self._c;return a("div",{staticClass:"audio-btn",class:{"is-playing":n.isPlaying,"is-loading":n.isLoading},attrs:{title:n.title},on:{click:n.handleClick}},[n.isLoading?a("Icon",{staticClass:"loading-icon",style:{color:"#3578e5"},attrs:{icon:"mdi:loading",width:"32",height:"32"}}):a("Icon",{style:{color:"#3578e5"},attrs:{icon:"mdi:volume-high",width:"32",height:"32"}})],1)},Tc=[],Dc=w(zc,Ac,Tc,!1,null,"727b9fb6");const Oc=Dc.exports;function Nc(e,n){try{return JSON.parse(sessionStorage.getItem(e))||n}catch{return n}}const $c="rv_word_cache";function Lc(e){return Nc($c,{})[e]||[]}const Pc={name:"Words",components:{WordsHeader:Pt,WordsProgress:Ft,AudioButton:Oc,CardActions:si,DictionaryLinks:di,SliderContainer:ci},data(){return{touchStartX:0,deltaX:0,isDragging:!1,isAnimating:!1,learningQueue:[],learningQueue_cache:[],currentIdx:0,revealedSet:new Set,phonetic:"",clicked:!1}},watch:{currentIdx(){}},computed:{curr_learning_word(){let e=this.learningQueue[this.currentIdx];return this.words[e].en},...I("cache",["add_usr_learned_no"]),...Q("book",["currentBookIdx","wordBooks","words","GROUP_SIZE","currentGroup"]),...I("cache",["usr_learned_no_arr"]),...I("book",["bookName","bookId","groupCount","groupStart","groupEnd","getRvGroupWords"]),currWord(){return this.sliderWords[1]},sliderWords(){const e=this.learningQueue[this.currentIdx-1],n=this.learningQueue[this.currentIdx],a=this.learningQueue[this.currentIdx+1],t=r=>typeof r=="number"?this.words[r]||{en:"",zh:"",enDef:""}:{en:"",zh:"",enDef:""};let i=[t(e),t(n),t(a)];return console.log("[sld_words]",i,e,n,a,this.learningQueue),i},...I("book",["progressPercent","progressText","words"]),isZhRevealed(){return this.revealedSet.has(this.learningQueue[this.currentIdx])},...I(["cacheWrapper"])},methods:{...H("book",["setCurrentBookIdx"]),...H(["setStudyStatus"]),getWordAudioUrl:It,splitTaggedText:qt,onTouchStart(e){this.isAnimating||this.learningQueue.length===0||(this.isDragging=!0,this.touchStartX=e.changedTouches[0].clientX,this.deltaX=0)},onTouchMove(e){if(!this.isDragging)return;const n=e.changedTouches[0].clientX-this.touchStartX;this.deltaX=n},async onTouchEnd(){if(!this.isDragging)return;this.isDragging=!1;const e=window.innerWidth/4;Math.abs(this.deltaX)>e&&(this.isAnimating=!0,this.deltaX>0?this.currentIdx>0?this.currentIdx--:this.currentIdx=this.learningQueue.length-1:this.currentIdx<this.learningQueue.length-1?this.currentIdx++:this.currentIdx=0,this.revealedSet.clear(),this.afterChange()),this.deltaX=0,await Un(300),this.isAnimating=!1},async afterChange(){let e=this.currWord;this.phonetic=await Rt((e==null?void 0:e.en)||""),this.playCurrentWord()},revealZh(){this.revealedSet.add(this.learningQueue[this.currentIdx]),this.revealedSet=new Set(this.revealedSet)},passWord(){if(pi(this.curr_learning_word),this.learningQueue.length<=1){this.nextGroupOrFinish();return}if(this.learningQueue.splice(this.currentIdx,1),this.learningQueue.length===0){this.nextGroupOrFinish();return}this.currentIdx>=this.learningQueue.length&&(this.currentIdx=this.learningQueue.length-1),this.revealedSet.clear(),this.afterChange()},failWord(){ji(this.curr_learning_word),this.currentIdx<this.learningQueue.length-1?this.currentIdx++:this.currentIdx=0,Ps(),this.revealedSet.clear()},async nextGroupOrFinish(){Ut(),await this.openGroupFinishModal()},async openAllFinishModal(){let e=await Pn({bookName:this.bookName,subtitle:"复习结束啦",restartText:"再来一次",homeText:"休息一下"});e.success&&(e.data?this.restartLearning():this.stopLearning())},async openGroupFinishModal(){let{currentGroup:e}=this,n=await Pn({bookName:`${this.bookName} - 第${e+1}组`,subtitle:"当前组已学完，是否继续下一组？",restartText:"继续下一组",homeText:"休息一下"});n.success&&(n.data?this.continueToNextGroup():this.stopAtCurrentGroup())},async restartLearning(){this.currentGroup=0,await this.initLearningQueue(),this.setStudyStatus(g.LEARNED)},async continueToNextGroup(){this.moveToNextGroup(),await this.initLearningQueue()},stopAtCurrentGroup(){this.setStudyStatus(g.LEARNED),gn()},async initLearningQueue(){let n=this.getRvGroupWords().map(t=>this.words[t].en),a=(await ie.getWords(n)).filter(t=>t).sort((t,i)=>t.next_review-i.next_review).map(t=>t.idx);this.learningQueue=a,console.log("[this.learningQueue initLearningQueue]",this.learningQueue),this.currentIdx=0,this.revealedSet=new Set,this.deltaX=0,this.isDragging=!1,this.isAnimating=!1},...Kn("book",["loadBook","saveProgress","moveToNextGroup"]),async loadProgress(){await this.initLearningQueue(),this.afterChange()},stopLearning(){this.setStudyStatus(g.LEARNED),gn()},async openBookModal(){mi()},async playCurrentWord(){this.clicked&&this.$refs.audioButton.play()}},async mounted(){await this.loadProgress(),this.learningQueue_cache=Lc(this.bookId),this.learningQueue=this.learningQueue.filter(e=>!this.learningQueue_cache.includes(e)),this.learningQueue.length===0&&this.openAllFinishModal()},beforeDestroy(){}};var Fc=function(){var n=this,a=n._self._c;return a("div",{staticClass:"words-page",on:{click:function(t){n.clicked=!0},touchstart:n.onTouchStart,touchmove:n.onTouchMove,touchend:n.onTouchEnd}},[a("WordsHeader",{attrs:{title:n.bookName},on:{change:n.openBookModal}}),a("WordsProgress",{directives:[{name:"show",rawName:"v-show",value:n.learningQueue.length>0,expression:"learningQueue.length > 0"}],attrs:{total:n.learningQueue.length,current:n.currentIdx+1}}),a("SliderContainer",{attrs:{items:n.sliderWords,isAnimating:n.isAnimating,deltaX:n.deltaX},scopedSlots:n._u([{key:"default",fn:function({item:t}){var i;return[a("div",{staticClass:"word-en"},[n._v(n._s(t.en))]),a("div",{staticStyle:{display:"flex","flex-wrap":"nowrap","align-items":"center",gap:"16px"}},[a("div",{staticClass:"phonetic-text",staticStyle:{"min-width":"100px",cursor:"pointer",color:"#666","font-family":"'IPA', monospace"},on:{click:n.playCurrentWord}},[n._v(" "+n._s(n.phonetic)+" ")]),a("AudioButton",{ref:"audioButton",attrs:{word:(i=n.currWord)==null?void 0:i.en,title:"播放发音"}})],1),a("div",{staticClass:"word-zh",class:{mosaic:!n.isZhRevealed},on:{click:n.revealZh}},n._l(n.splitTaggedText(t.zh),function(r){return a("div",{key:r,staticClass:"word-zh-item"},[n._v(" "+n._s(r)+" ")])}),0),a("DictionaryLinks",{attrs:{word:t.en}})]}}])}),a("CardActions",{on:{pass:n.passWord,fail:n.failWord}})],1)},Bc=[],Mc=w(Pc,Fc,Bc,!1,null,"e0dfb5f1");const Uc=Mc.exports,Wc={name:"WordBookItem",props:{bookName:String,wordTotal:Number,learnedCount:Number,isActive:{type:Boolean,default:!1}},computed:{progress_count(){return this.learnedCount},progress_percentage(){return(this.learnedCount/this.wordTotal).toFixed(4)}}};var Gc=function(){var n=this,a=n._self._c;return a("li",{class:{active:n.isActive}},[a("div",{staticClass:"book-info"},[a("span",{staticClass:"book-name"},[n._v(n._s(n.bookName))]),a("span",{staticClass:"book-count"},[n._v(n._s(n.wordTotal)+"词")]),a("span",{staticClass:"book-progress"},[n._v(" "+n._s(n.progress_percentage)+"% 已学"+n._s(n.progress_count)+"词 ")])]),a("div",{staticClass:"book-actions"},[n.isActive?a("span",{staticClass:"current-label"},[n._v("当前")]):a("button",{staticClass:"switch-btn",on:{click:function(t){return n.$emit("select")}}},[n._v("切换")]),n._e()])])},Vc=[],Hc=w(Wc,Gc,Vc,!1,null,"3bf26e33");const Qc=Hc.exports,Xc={name:"WordBooks",components:{WordBookItem:Qc},data(){return{}},computed:{...Q("cache",["wordBooks","usr_bookIdx"]),...I("cache",["usr_bookIdx","usr_progress"]),...I("cache",["set_usr_bookIdx"])},methods:{selectBook(e){this.set_usr_bookIdx(e),V.success("已切换词库")}},mounted(){console.log("[this.usr_progress]",this.usr_progress)}};var Jc=function(){var n=this,a=n._self._c;return a("div",{staticClass:"wordbooks-page"},[n._m(0),n.wordBooks.length===0?a("div",{staticClass:"empty-tip"},[n._v("暂无词库，请导入或添加新词库")]):n._e(),a("ul",{staticClass:"book-list"},n._l(n.wordBooks,function(t,i){var r,o;return a("WordBookItem",{key:t.id,attrs:{"book-name":t.name,"word-total":t.words.length,"learned-count":((o=(r=n.usr_progress[t.id])==null?void 0:r.learned_no_arr)==null?void 0:o.length)||0,"is-active":i===n.usr_bookIdx},on:{select:function(s){return n.selectBook(i)}}})}),1),n._e()])},Kc=[function(){var e=this,n=e._self._c;return n("header",{staticClass:"wb-header"},[n("h2",{staticClass:"title"},[e._v("词库管理")])])}],Yc=w(Xc,Jc,Kc,!1,null,"fe984f56");const Zc=Yc.exports,nl={name:"Index",components:{WaPhoneticAudio:Gt},data(){return{dailyWord:null,buttonLoading:!1}},methods:{...H(["setStudyStatus"]),goNext(e){},handleButtonClick(e){this.buttonLoading||(this.buttonLoading=!0,Promise.resolve(e.action()).finally(()=>{setTimeout(()=>{this.buttonLoading=!1},500)}))}},computed:{bgStyle(){var e;return`background-image: url(${((e=this==null?void 0:this.dailyWord)==null?void 0:e.bg)||""});`},goOptions(){return this.study_status===g.DEFAULT?[{text:"背单词",nextStatus:g.LEARNING,type:"primary",action:()=>{this.setStudyStatus(g.LEARNING),tn()}},{text:"复习",nextStatus:g.REVIEWING,type:"secondary",action:()=>{this.setStudyStatus(g.REVIEWING),Cn()}}]:this.study_status===g.LEARNING?[{text:"继续背单词",nextStatus:g.LEARNING,type:"primary",action:()=>{this.setStudyStatus(g.LEARNING),tn()}}]:this.study_status===g.LEARNED?[{text:"再背一组",nextStatus:g.LEARNING,type:"primary",action:()=>{this.setStudyStatus(g.LEARNING),tn()}},{text:"复习",nextStatus:g.REVIEWING,type:"secondary",action:()=>{this.setStudyStatus(g.REVIEWING),Cn()}}]:this.study_status===g.REVIEWING?[{text:"背单词",nextStatus:g.LEARNING,type:"primary",action:()=>{this.setStudyStatus(g.LEARNING),tn()}},{text:"继续复习",nextStatus:g.REVIEWING,type:"secondary",action:()=>{this.setStudyStatus(g.REVIEWING),Cn()}}]:this.study_status===g.REVIEWED?[{text:"背单词",nextStatus:g.DEFAULT,type:"primary",action:()=>{this.setStudyStatus(g.DEFAULT),tn()}},{text:"复习",nextStatus:g.REVIEWING,type:"secondary",action:()=>{this.setStudyStatus(g.REVIEWING),Cn()}}]:[{text:"背单词",nextStatus:g.DEFAULT,type:"primary",action:()=>{this.setStudyStatus(g.DEFAULT),tn()}}]},...Q(["study_status"]),buttonText(){switch(this.study_status){case g.DEFAULT:return"背单词";case g.LEARNING:return"继续背单词";case g.LEARNED:return"复习"}}},async mounted(){var t,i,r,o;let n=(await Ro()).data.data,a={en:n.word,zh:n.translations.map(s=>`${s.pos}. ${s.tran_cn}`).join(`
`),sentence_en:(i=(t=n==null?void 0:n.sentences)==null?void 0:t[0])==null?void 0:i.s_content,sentence_zh:(o=(r=n==null?void 0:n.sentences)==null?void 0:r[0])==null?void 0:o.s_cn,ukphone:`/${n==null?void 0:n.ukphone}/`,ukspeech:n==null?void 0:n.ukspeech,bg:`https://image.pollinations.ai/prompt/${n.word}`};this.dailyWord=a}};var el=function(){var n=this,a=n._self._c;return a("div",{staticClass:"index-page"},[a("div",{staticClass:"bg-img",style:n.bgStyle}),n.dailyWord?a("div",{staticClass:"content"},[a("div",{staticClass:"daily-word-block"},[a("div",{staticClass:"daily-label"},[n._v("每日精选单词")]),a("div",{staticClass:"daily-word"},[n._v(n._s(n.dailyWord.en))]),a("div",{staticStyle:{display:"flex",gap:"4px","align-items":"center","justify-content":"center"}},[n.dailyWord.ukspeech?[a("wa-phonetic-audio",{attrs:{phonetic:n.dailyWord.ukphone,audioUrl:n.dailyWord.ukspeech}})]:n._e(),n.dailyWord.usspeech?[a("wa-phonetic-audio",{attrs:{phonetic:n.dailyWord.usphone,audioUrl:n.dailyWord.usspeech}})]:n._e()],2),a("div",{staticClass:"daily-zh"},[n._v(n._s(n.dailyWord.zh))])]),a("div",{staticClass:"daily-sentence-block"},[a("div",{staticClass:"sentence-label"},[n._v("每日英文句子")]),a("div",{staticClass:"sentence-en"},[n._v("“"+n._s(n.dailyWord.sentence_en)+"”")]),a("div",{staticClass:"sentence-zh"},[n._v(n._s(n.dailyWord.sentence_zh))])]),a("div",{staticClass:"f_button_group"},n._l(n.goOptions,function(t){return a("button",{key:t.status,staticClass:"start-btn",class:t.type||"primary",attrs:{disabled:n.buttonLoading},on:{click:function(i){return n.handleButtonClick(t)}}},[n._v(" "+n._s(t.text)+" ")])}),0)]):n._e()])},al=[],tl=w(nl,el,al,!1,null,"0329f3fb");const il=tl.exports,rl={name:"Redirect",created(){const{params:e,query:n}=this.$route,{path:a}=e;this.$router.replace({path:"/"+a,query:n})},render:function(e){return e()}};var ol=function(){var n=this,a=n._self._c;return a("div")},sl=[],dl=w(rl,ol,sl,!1,null,null);const cl=dl.exports,ll={name:"WaModal",props:{visible:Boolean,title:String,content:String,confirmText:{type:String,default:"确认"},cancelText:{type:String,default:"取消"}},methods:{onConfirm(){this.$emit("confirm")},onCancel(){this.$emit("cancel")}}};var vl=function(){var n=this,a=n._self._c;return n.visible?a("div",{staticClass:"wa-modal-mask",on:{click:function(t){return t.target!==t.currentTarget?null:n.onCancel.apply(null,arguments)}}},[a("div",{staticClass:"wa-modal"},[n.title?a("div",{staticClass:"wa-modal-title"},[n._v(n._s(n.title))]):n._e(),a("div",{staticClass:"wa-modal-content"},[n._t("default",function(){return[n._v(n._s(n.content))]})],2),a("div",{staticClass:"wa-modal-actions"},[a("button",{staticClass:"wa-btn wa-btn-cancel",on:{click:n.onCancel}},[n._v(n._s(n.cancelText))]),a("button",{staticClass:"wa-btn wa-btn-confirm",on:{click:n.onConfirm}},[n._v(n._s(n.confirmText))])])])]):n._e()},ul=[],pl=w(ll,vl,ul,!1,null,"ad8f068b");const jl=pl.exports;let D=null;function ml(e){return hl({content:e,confirmText:"确认",cancelText:"取消"})}function hl({title:e="",content:n="",confirmText:a="确认",cancelText:t="取消"}={}){return new Promise(i=>{const r=M.extend(jl);D=new r({propsData:{visible:!0,title:e,content:n,confirmText:a,cancelText:t}}),D.$mount(),document.body.appendChild(D.$el);const o=()=>{D&&(D.$destroy(),D.$el&&D.$el.parentNode&&D.$el.parentNode.removeChild(D.$el),D=null)};D.$on("confirm",()=>{o(),i(!0)}),D.$on("cancel",()=>{o(),i(!1)})})}async function fl(){try{if(await ml("确定要清理缓存吗？"))return;if(localStorage.clear(),sessionStorage.clear(),(await window.indexedDB.databases()).forEach(n=>{n.name&&window.indexedDB.deleteDatabase(n.name)}),"caches"in window){const n=await caches.keys();await Promise.all(n.map(a=>caches.delete(a)))}window.word_cache&&(window.word_cache={}),this.$message.success("缓存清理成功，页面将在3秒后刷新"),await Un(300)}catch(e){console.error("清理缓存失败:",e),this.$message.error("清理缓存失败，请重试")}finally{window.location.reload(!0)}}const gl={name:"WaInputNumber",props:{value:{type:[Number,String],default:0},min:{type:Number,default:-1/0},max:{type:Number,default:1/0},step:{type:Number,default:1},disabled:{type:Boolean,default:!1}},data(){return{currValue:this.value||0}},watch:{value(e){this.currValue=e}},methods:{onInput(e){let n=Number(e.target.value);isNaN(n)&&(n=this.min),n<this.min&&(n=this.min),n>this.max&&(n=this.max),console.log("[input]",n),this.$emit("input",n)},onChange(e){let n=Number(e.target.value);isNaN(n)&&(n=this.min),n<this.min&&(n=this.min),n>this.max&&(n=this.max),console.log("[change]",n),this.$emit("change",n)},increment(){if(this.disabled)return;let e=this.value+this.step;e>this.max&&(e=this.max),console.log("[increment]",e),this.$emit("input",e),this.$emit("change",e)},decrement(){if(this.disabled)return;let e=this.value-this.step;e<this.min&&(e=this.min),console.log("[decrement]",e),this.$emit("input",e),this.$emit("change",e)}}};var yl=function(){var n=this,a=n._self._c;return a("div",{staticClass:"wa-input-number",class:{"wa-input-number--disabled":n.disabled}},[a("button",{staticClass:"wa-btn wa-btn-minus",attrs:{disabled:n.disabled||n.value<=n.min},on:{click:n.decrement}},[n._v(" - ")]),a("input",{directives:[{name:"model",rawName:"v-model",value:n.currValue,expression:"currValue"}],staticClass:"wa-input",attrs:{min:n.min,max:n.max,step:n.step,disabled:n.disabled},domProps:{value:n.currValue},on:{change:n.onChange,input:function(t){t.target.composing||(n.currValue=t.target.value)}}}),a("button",{staticClass:"wa-btn wa-btn-plus",attrs:{disabled:n.disabled||n.value>=n.max},on:{click:n.increment}},[n._v(" + ")])])},bl=[],wl=w(gl,yl,bl,!1,null,"388ee77e");const kl=wl.exports,xl={name:"WaSwitch",props:{modelValue:{type:Boolean,default:!1},disabled:{type:Boolean,default:!1}},methods:{onChange(e){const n=e.target.checked;this.$emit("update:modelValue",n),this.$emit("input",n),this.$emit("change",n)}}};var _l=function(){var n=this,a=n._self._c;return a("label",{staticClass:"wa-switch",class:{"wa-switch--disabled":n.disabled}},[a("input",{attrs:{type:"checkbox",disabled:n.disabled},domProps:{checked:n.modelValue},on:{change:n.onChange}}),a("span",{staticClass:"wa-slider"})])},El=[],Sl=w(xl,_l,El,!1,null,"9cd67540");const Cl=Sl.exports,Il={name:"Settings",components:{WaInputNumber:kl,WaSwitch:Cl},data(){return{theme:"light",showPhonetic:!0,autoPlayAudio:!1,showDictionary:!0,enableShortcuts:!0}},computed:{...Q("setting",["groupSize"]),...I("setting",["setGroupSize","setDebug"]),currGroupSize:{get(){return this.groupSize},set(e){console.log("[value]",e),this.setGroupSize(e)}},currDebug:{get(){return this.debug},set(e){this.setDebug(e)}}},methods:{clearSysCache:fl,saveSettings(){alert("设置已保存（仅本地演示，未持久化）")}}};var ql=function(){var n=this,a=n._self._c;return a("div",{staticClass:"settings-page"},[a("div",{staticClass:"settings-group"},[a("div",{staticClass:"settings-title"},[n._v("通用")]),a("div",{staticClass:"setting-item"},[a("span",{staticClass:"setting-label"},[n._v("调试模式")]),a("wa-switch",{model:{value:n.currDebug,callback:function(t){n.currDebug=t},expression:"currDebug"}})],1),a("div",{staticClass:"setting-item"},[a("span",{staticClass:"setting-label"},[n._v("主单词字号")]),a("div",{staticClass:"setting-control"},[a("wa-input-number",{attrs:{min:10,max:40,step:1},model:{value:n.currGroupSize,callback:function(t){n.currGroupSize=t},expression:"currGroupSize"}})],1)]),a("div",{staticClass:"setting-item",on:{click:n.clearSysCache}},[a("span",{staticClass:"setting-label",staticStyle:{color:"#3578e5"}},[n._v("清理缓存")])])]),a("div",{staticClass:"settings-footer"},[n._v("更多设置即将开放…")])])},Rl=[],zl=w(Il,ql,Rl,!1,null,"4805437e");const Al=zl.exports,Tl={name:"RecordView",data(){return{loading:!0,records:[],filteredRecords:[],chart:null,touchStartX:0,touchStartY:0,selectedRange:"7"}},computed:{hasData(){return this.filteredRecords.length>0}},methods:{formatDate(e){const n=new Date(e),a=n.getMonth()+1,t=n.getDate();return`${a}/${t}`},getDateRange(){const e=new Date;if(e.setHours(23,59,59,999),this.selectedRange==="all")return{start:new Date(0),end:e};const n=new Date;return n.setDate(e.getDate()-parseInt(this.selectedRange)),n.setHours(0,0,0,0),{start:n,end:e}},handleRangeChange(){this.filterRecords();const e=this.processData(this.filteredRecords);this.initChart(e)},filterRecords(){const{start:e,end:n}=this.getDateRange();this.filteredRecords=this.records.filter(a=>{const t=new Date(a.timestamp);return t>=e&&t<=n})},processData(e){const n={dates:[],learningPass:[],learningFail:[],reviewPass:[],reviewFail:[]},a={};return e.forEach(t=>{const i=new Date(t.timestamp).toLocaleDateString();a[i]||(a[i]={learningPass:0,learningFail:0,reviewPass:0,reviewFail:0}),t.type===Tn.LEARNING?t.status===B.PASS?a[i].learningPass++:a[i].learningFail++:t.status===B.PASS?a[i].reviewPass++:a[i].reviewFail++}),Object.keys(a).sort().forEach(t=>{n.dates.push(this.formatDate(t)),n.learningPass.push(a[t].learningPass),n.learningFail.push(a[t].learningFail),n.reviewPass.push(a[t].reviewPass),n.reviewFail.push(a[t].reviewFail)}),n},initChart(e){if(!this.$refs.chartContainer)return;this.chart=hi(this.$refs.chartContainer);const n={tooltip:{trigger:"axis",axisPointer:{type:"shadow"},formatter:function(a){let t=a[0].axisValue+"<br/>";return a.forEach(i=>{const r=i.value;r>0&&(t+=`${i.marker} ${i.seriesName}: ${r}<br/>`)}),t}},legend:{data:["学习通过","学习失败","复习通过","复习失败"],top:0,textStyle:{fontSize:12}},grid:{left:"3%",right:"4%",bottom:"3%",top:"40px",containLabel:!0},xAxis:{type:"category",data:e.dates,axisLabel:{interval:0,rotate:45,fontSize:12}},yAxis:{type:"value",name:"数量",nameTextStyle:{fontSize:12},axisLabel:{fontSize:12}},series:[{name:"学习通过",type:"bar",stack:"total",data:e.learningPass,itemStyle:{color:"#91cc75"},emphasis:{focus:"series"}},{name:"学习失败",type:"bar",stack:"total",data:e.learningFail,itemStyle:{color:"#ee6666"},emphasis:{focus:"series"}},{name:"复习通过",type:"bar",stack:"total",data:e.reviewPass,itemStyle:{color:"#5470c6"},emphasis:{focus:"series"}},{name:"复习失败",type:"bar",stack:"total",data:e.reviewFail,itemStyle:{color:"#fac858"},emphasis:{focus:"series"}}]};this.chart.setOption(n),this.$refs.chartContainer.addEventListener("touchstart",this.handleTouchStart),this.$refs.chartContainer.addEventListener("touchmove",this.handleTouchMove)},handleTouchStart(e){this.touchStartX=e.touches[0].clientX,this.touchStartY=e.touches[0].clientY},handleTouchMove(e){if(!this.touchStartX||!this.touchStartY)return;const n=e.touches[0].clientX,a=e.touches[0].clientY,t=n-this.touchStartX,i=a-this.touchStartY;Math.abs(t)>Math.abs(i)&&e.preventDefault()},async loadData(){try{this.loading=!0,this.records=await Bn.getAllRecords(),this.filterRecords();const e=this.processData(this.filteredRecords);this.loading=!1,await this.$nextTick(()=>{}),this.initChart(e)}catch(e){console.error("加载数据失败:",e)}finally{this.loading=!1}},async generateTestData(){try{this.loading=!0,await Bn.generateTestData(),await this.loadData()}catch(e){console.error("生成测试数据失败:",e)}finally{this.loading=!1}},handleResize(){this.chart&&this.chart.resize()}},mounted(){this.loadData(),window.addEventListener("resize",this.handleResize)},beforeDestroy(){window.removeEventListener("resize",this.handleResize),this.$refs.chartContainer&&(this.$refs.chartContainer.removeEventListener("touchstart",this.handleTouchStart),this.$refs.chartContainer.removeEventListener("touchmove",this.handleTouchMove)),this.chart&&this.chart.dispose()}};var Dl=function(){var n=this,a=n._self._c;return a("div",{staticClass:"record-view"},[a("div",{staticClass:"date-range-picker"},[a("select",{directives:[{name:"model",rawName:"v-model",value:n.selectedRange,expression:"selectedRange"}],on:{change:[function(t){var i=Array.prototype.filter.call(t.target.options,function(r){return r.selected}).map(function(r){var o="_value"in r?r._value:r.value;return o});n.selectedRange=t.target.multiple?i:i[0]},n.handleRangeChange]}},[a("option",{attrs:{value:"7"}},[n._v("最近7天")]),a("option",{attrs:{value:"14"}},[n._v("最近14天")]),a("option",{attrs:{value:"30"}},[n._v("最近30天")]),a("option",{attrs:{value:"90"}},[n._v("最近90天")]),a("option",{attrs:{value:"all"}},[n._v("全部")])])]),n.loading?a("div",{staticClass:"loading"},[a("div",{staticClass:"loading-spinner"}),a("span",[n._v("加载中...")])]):n.hasData?a("div",{ref:"chartContainer",staticClass:"chart-container"}):a("div",{staticClass:"empty-state"},[a("div",{staticClass:"empty-icon"},[n._v("📊")]),a("p",[n._v("暂无学习记录")]),a("p",{staticClass:"empty-tip"},[n._v("开始学习单词后，这里会显示您的学习进度")]),a("button",{staticClass:"generate-btn",on:{click:n.generateTestData}},[n._v("生成测试数据")])])])},Ol=[],Nl=w(Tl,Dl,Ol,!1,null,"b1d234b9");const $l=Nl.exports;M.use(Ga);const kn=new Ga({routes:[{path:"/",component:il,name:"首页"},{path:"/recognize",component:ns,name:"图片识别"},{path:"/words",component:Rc,name:"背单词"},{path:"/reviewWords",component:Uc,name:"复习单词"},{path:"/wordbooks",component:Zc,name:"词库"},{path:"/records",component:$l,name:"学习记录"},{path:"/redirect/:path(.*)",component:cl},{path:"/settings",component:Al,name:"设置"}]});function gn(){kn.push("/")}function tn(){kn.push("/words")}function Cn(){console.log("[gotoReviewWords]"),kn.push("/reviewWords")}function mi(){kn.push("/wordbooks")}const Ll={name:"BackToHome",methods:{goHome(){gn()}}};var Pl=function(){var n=this,a=n._self._c;return a("button",{staticClass:"back-home-btn",attrs:{title:"返回首页"},on:{click:n.goHome}},[a("svg",{attrs:{width:"22",height:"22",viewBox:"0 0 24 24",fill:"none",stroke:"#3578e5","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round"}},[a("path",{attrs:{d:"M3 12L12 3l9 9"}}),a("path",{attrs:{d:"M9 21V9h6v12"}})])])},Fl=[],Bl=w(Ll,Pl,Fl,!1,null,"5bad460e");const Ml=Bl.exports,Ul={name:"BackButton",data(){return{canGoBack:!1}},watch:{$route:{immediate:!0,handler(e,n){this.canGoBack=window.history.length>1}}},methods:{goBack(){this.$router.back()}}};var Wl=function(){var n=this,a=n._self._c;return n.canGoBack?a("button",{staticClass:"back-btn",attrs:{title:"返回上一页"},on:{click:n.goBack}},[a("svg",{attrs:{width:"22",height:"22",viewBox:"0 0 24 24",fill:"none",stroke:"#3578e5","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round"}},[a("path",{attrs:{d:"M15 18l-6-6 6-6"}})])]):n._e()},Gl=[],Vl=w(Ul,Wl,Gl,!1,null,"edd6c788");const Hl=Vl.exports,Ql={name:"FabMenu",data(){return{menuOpen:!1,dragging:!1,dragStart:{x:0,y:0},pos:{left:16,bottom:16},expandTo:"left"}},computed:{...Q(["isFullscreen"]),menuItems(){return[{label:"图片识别",icon:"📷",route:"/recognize?auto=true"},{label:"词库",icon:"📚",route:"/wordbooks"},{label:"学习记录",icon:"📊",route:"/records"},{label:"全屏",icon:this.fullscreenIcon,action:"toggleFullscreen"},{label:"设置",icon:"⚙️",route:"/settings"}]},fullscreenIcon(){return this.isFullscreen?"🔳":"🔲"}},methods:{toggleMenu(){this.menuOpen||this.snapToEdge(),this.menuOpen=!this.menuOpen},snapToEdge(){const e=this.$el.getBoundingClientRect(),n=e.left<window.innerWidth/2;this.expandTo=n?"right":"left",n?this.pos.left=16:this.pos.left=window.innerWidth-e.width-16},onDragStart(e){this.dragging=!0;const n=e.touches?e.touches[0]:e;this.dragStart={x:n.clientX,y:n.clientY,left:this.pos.left,bottom:this.pos.bottom},document.addEventListener("mousemove",this.onDragMove),document.addEventListener("mouseup",this.onDragEnd),document.addEventListener("touchmove",this.onDragMove,{passive:!1}),document.addEventListener("touchend",this.onDragEnd)},onDragMove(e){if(!this.dragging)return;const n=e.touches?e.touches[0]:e,a=n.clientX-this.dragStart.x,t=this.dragStart.y-n.clientY;let i=this.dragStart.left+a,r=this.dragStart.bottom+t;const o=this.$el.getBoundingClientRect();i=Math.max(0,Math.min(window.innerWidth-o.width,i)),r=Math.max(0,Math.min(window.innerHeight-o.height,r)),this.pos={left:i,bottom:r},e.preventDefault&&e.preventDefault()},onDragEnd(e){this.dragging=!1,document.removeEventListener("mousemove",this.onDragMove),document.removeEventListener("mouseup",this.onDragEnd),document.removeEventListener("touchmove",this.onDragMove),document.removeEventListener("touchend",this.onDragEnd);const n=this.$el.getBoundingClientRect(),a=n.left<window.innerWidth/2;a?this.pos.left=16:this.pos.left=window.innerWidth-n.width-16,this.menuOpen&&(this.expandTo=a?"right":"left")},handleGlobalClick(e){if(!this.menuOpen)return;let n=e.target;for(;n;){if(n.classList&&n.classList.contains("fab-menu"))return;n=n.parentElement}this.menuOpen=!1},...H(["setCacheFrozen","setIsFullscreen"]),async clearCache(){this.setCacheFrozen(!0);try{if(localStorage.clear(),sessionStorage.clear(),(await window.indexedDB.databases()).forEach(n=>{n.name&&window.indexedDB.deleteDatabase(n.name)}),"caches"in window){const n=await caches.keys();await Promise.all(n.map(a=>caches.delete(a)))}window.word_cache&&(window.word_cache={}),this.$message.success("缓存清理成功，页面将在3秒后刷新"),await Un(300)}catch(e){console.error("清理缓存失败:",e),this.$message.error("清理缓存失败，请重试")}finally{this.setCacheFrozen(!1),window.location.reload(!0)}},goMenu(e){e.action==="clearCache"?this.clearCache():e.action==="toggleFullscreen"?this.setIsFullscreen(!this.isFullscreen):e.route?this.$router.push(e.route):this.$router.replace({path:"/redirect"+this.$route.fullPath}),this.menuOpen=!1}},mounted(){document.addEventListener("mousedown",this.handleGlobalClick),document.addEventListener("touchstart",this.handleGlobalClick),this.snapToEdge()},beforeDestroy(){document.removeEventListener("mousedown",this.handleGlobalClick),document.removeEventListener("touchstart",this.handleGlobalClick)}};var Xl=function(){var n=this,a=n._self._c;return a("div",{staticClass:"fab-menu",style:{left:n.pos.left+"px",bottom:n.pos.bottom+"px"},on:{touchstart:n.onDragStart,mousedown:n.onDragStart}},[a("button",{staticClass:"fab-main",on:{click:n.toggleMenu}},[a("Icon",{attrs:{icon:"mdi:plus",width:"28",height:"28"}})],1),a("transition",{attrs:{name:"fab-menu-fade"}},[n.menuOpen?a("div",{staticClass:"fab-menu-list",class:n.expandTo},n._l(n.menuItems,function(t){return a("button",{key:t.action,staticClass:"fab-menu-item",on:{click:function(i){return n.goMenu(t)}}},[a("span",{staticClass:"icon"},[n._v(n._s(t.icon))]),a("span",{staticClass:"label"},[n._v(n._s(t.label))])])}),0):n._e()])],1)},Jl=[],Kl=w(Ql,Xl,Jl,!1,null,"7653fdb1");const Yl=Kl.exports,Zl={name:"App",components:{BackToHome:Ml,BackButton:Hl,FabMenu:Yl},methods:{toggleFullscreen(){toggleFullscreen(this.$el)}},beforeCreate(){So()}};var nv=function(){var n=this,a=n._self._c;return a("div",{attrs:{id:"app"}},[n.$route.path!=="/"?[a("BackButton"),a("BackToHome")]:n._e(),a("router-view"),n._e(),n.$route.path!=="/settings"?a("FabMenu"):n._e()],2)},ev=[],av=w(Zl,nv,ev,!1,null,null);const tv=av.exports,iv="modulepreload",rv=function(e){return"/word-app/"+e},Wa={},ov=function(n,a,t){let i=Promise.resolve();if(a&&a.length>0){let o=function(d){return Promise.all(d.map(l=>Promise.resolve(l).then(v=>({status:"fulfilled",value:v}),v=>({status:"rejected",reason:v}))))};document.getElementsByTagName("link");const s=document.querySelector("meta[property=csp-nonce]"),c=(s==null?void 0:s.nonce)||(s==null?void 0:s.getAttribute("nonce"));i=o(a.map(d=>{if(d=rv(d),d in Wa)return;Wa[d]=!0;const l=d.endsWith(".css"),v=l?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${v}`))return;const j=document.createElement("link");if(j.rel=l?"stylesheet":iv,l||(j.as="script"),j.crossOrigin="",j.href=d,c&&j.setAttribute("nonce",c),document.head.appendChild(j),l)return new Promise((p,m)=>{j.addEventListener("load",p),j.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${d}`)))})}))}function r(o){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=o,window.dispatchEvent(s),!s.defaultPrevented)throw o}return i.then(o=>{for(const s of o||[])s.status==="rejected"&&r(s.reason);return n().catch(r)})};function sv(e={}){const{immediate:n=!1,onNeedRefresh:a,onOfflineReady:t,onRegistered:i,onRegisteredSW:r,onRegisterError:o}=e;let s,c;const d=async(v=!0)=>{await c};async function l(){if("serviceWorker"in navigator){if(s=await ov(async()=>{const{Workbox:v}=await import("./workbox-window.prod.es5-B9K5rw8f.js");return{Workbox:v}},[]).then(({Workbox:v})=>new v("/word-app/sw.js",{scope:"/word-app/",type:"classic"})).catch(v=>{o==null||o(v)}),!s)return;s.addEventListener("activated",v=>{(v.isUpdate||v.isExternal)&&window.location.reload()}),s.addEventListener("installed",v=>{v.isUpdate||t==null||t()}),s.register({immediate:n}).then(v=>{r?r("/word-app/sw.js",v):i==null||i(v)}).catch(v=>{o==null||o(v)})}}return c=l(),d}M.component("Icon",wn);const dv=sv({onNeedRefresh(){confirm("有新版本可用，是否更新？")&&dv()},onOfflineReady(){console.log("应用已准备就绪，可以离线使用")}});let cv=new URL(location.href),lv=cv.searchParams.get("_debug")==="true";Lt.getters["setting/setDebug"](lv);new M({router:kn,store:Lt,render:e=>e(tv)}).$mount("#app");
